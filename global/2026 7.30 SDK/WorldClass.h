...
public:
    ...
    // --- Functions ---
    void RefreshConfigByShowType(int32 ShowType, bool CallFunc_EqualEqual_IntInt_ReturnValue);  // [Public] RVA: 0x182D96C
};
...
public:
    ...
    // --- Functions ---
    void ReceiveBeginPlay();                                                                   // [Protected] RVA: 0x182D96C
    void ExecuteUbergraph_BP_SceneRenderingSettings(int32 EntryPoint);                         // [Final] RVA: 0x182D96C
};
...
public:
    ...
    // --- Functions ---
    FString GetModuleName();                                                                   // [Public] RVA: 0x182D96C
};
...
public:
    ...
    // --- Functions ---
    void UserConstructionScript(bool CallFunc_IsEditor_ReturnValue, const Transform Temp_struct_Variable, FluidMeshInteractorComponent* CallFunc_AddComponent_ReturnValue, HitResult CallFunc_K2_SetRelativeLocation_SweepHitResult, bool CallFunc_IsValid_ReturnValue);  // [Public] RVA: 0x182D96C
};
...
public:
    ...
    // --- Functions ---
    void ReceiveBeginPlay();                                                                   // [Protected] RVA: 0x182D96C
    void UpdatePostProcessComponentWeight(float Weight);                                       // [Public] RVA: 0x182D96C
    void ExecuteUbergraph_BP_UamPlayerCameraManagerTemplate(int32 EntryPoint, const Transform Temp_struct_Variable, PostProcessComponent* CallFunc_AddComponent_ReturnValue, float K2Node_Event_Weight);  // [Final] RVA: 0x182D96C
};
...
public:
    ...
    // --- Functions ---
    void UserConstructionScript();                                                             // [Public] RVA: 0x182D96C
};
...
public:
    ...
    // --- Functions ---
    void ProcessDebugCommand(FString Value);                                                   // [Public] RVA: 0x182D96C
    ...
    void BPC_AIDebugInitFinished__DelegateSignature(ActorComponent* BPC_AIDebug);              // [Public] RVA: 0x182D96C
    void DebugInit__DelegateSignature();                                                       // [Public] RVA: 0x182D96C
};
...
public:
    ...
    // --- Functions ---
    void ExecuteUbergraph_BP_CharacterBase(int32 EntryPoint);                                  // [Final] RVA: 0x182D96C
};
...
public:
    ...
    // --- Functions ---
    void UpdateFollowSpeed(float NewSpeed, float DestScale, bool CallFunc_IsValid_ReturnValue, GameplayEffectSpecHandle CallFunc_MakeOutgoingSpec_ReturnValue, float CallFunc_GetMaxSpeed_ReturnValue, GameplayEffectSpecHandle CallFunc_AssignTagSetByCallerMagnitude_ReturnValue, float CallFunc_Divide_FloatFloat_ReturnValue, bool CallFunc_Greater_FloatFloat_ReturnValue, ActiveGameplayEffectHandle CallFunc_BP_ApplyGameplayEffectSpecToSelf_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, float CallFunc_GetGameplayEffectMagnitude_ReturnValue, bool CallFunc_NotEqual_FloatFloat_ReturnValue);  // [Public] RVA: 0x182D96C
    void UserConstructionScript();                                                             // [Public] RVA: 0x182D96C
    void ReceiveBeginPlay();                                                                   // [Protected] RVA: 0x182D96C
    void ExecuteUbergraph_BP_Tutorial_AICharacterTemplate(int32 EntryPoint);                   // [Final] RVA: 0x182D96C
    void OnCrouchFinished__DelegateSignature(BP_Tutorial_AICharacterTemplate_C* InAIChar, bool bSuccess);  // [Public] RVA: 0x182D96C
    void OnWaitFinished__DelegateSignature(BP_Tutorial_AICharacterTemplate_C* InAIChar, bool bSuccess);  // [Public] RVA: 0x182D96C
    void OnAttackEnemyFinished__DelegateSignature(BP_Tutorial_AICharacterTemplate_C* InAIChar, bool bSuccess);  // [Public] RVA: 0x182D96C
    void OnMoveToTargetFinished__DelegateSignature(BP_Tutorial_AICharacterTemplate_C* InAIChar, bool bSuccess);  // [Public] RVA: 0x182D96C
    void OnFollowPathFinished__DelegateSignature(BP_Tutorial_AICharacterTemplate_C* InAIChar, bool bSuccess);  // [Public] RVA: 0x182D96C
};
...
public:
    ...
    // --- Functions ---
    bool NeedBlockLoadLevelWhenStartMatch();                                                   // [Protected] RVA: 0x182D96C
    void K2_OnRestartPlayer(Controller* NewPlayer);                                            // [Public] RVA: 0x182D96C
    void ExecuteUbergraph_BP_UamTutorialGameMode(int32 EntryPoint, Controller* K2Node_Event_NewPlayer);  // [Final] RVA: 0x182D96C
    void PlayLevelBEnding__DelegateSignature();                                                // [Public] RVA: 0x182D96C
    void PlayLevelAEnding__DelegateSignature();                                                // [Public] RVA: 0x182D96C
    void TogglePlayerGod__DelegateSignature(bool bNewGod);                                     // [Public] RVA: 0x182D96C
    void FinishSwitchCheckpoint__DelegateSignature();                                          // [Public] RVA: 0x182D96C
    void SwitchToCurrentCheckPoint__DelegateSignature();                                       // [Public] RVA: 0x182D96C
    void LevelB-End__DelegateSignature();                                                      // [Public] RVA: 0x182D96C
    void LevelB-Start__DelegateSignature();                                                    // [Public] RVA: 0x182D96C
    void LevelA-End__DelegateSignature();                                                      // [Public] RVA: 0x182D96C
    void LevelA-Start__DelegateSignature();                                                    // [Public] RVA: 0x182D96C
};
...
public:
    ...
    // --- Functions ---
    void InpActEvt_Period_K2Node_InputKeyEvent_0(Key Key);                                     // RVA: 0x182D96C
    void ServerDo();                                                                           // RVA: 0x182D96C
    void ClientCallHudMessage(int32 Messageid);                                                // RVA: 0x182D96C
    void ExecuteUbergraph_BP_UamTutorialPlayerController(int32 EntryPoint, bool CallFunc_Not_PreBool_ReturnValue, int32 K2Node_CustomEvent_MessageID, Key K2Node_InputKeyEvent_Key);  // [Final] RVA: 0x182D96C
    void B1MediaFinished__DelegateSignature();                                                 // [Public] RVA: 0x182D96C
    void SwitchToB2__DelegateSignature();                                                      // [Public] RVA: 0x182D96C
    void TutorialHudMessageDispatcher__DelegateSignature(int32 Messageid);                     // [Public] RVA: 0x182D96C
    void TutorialPCEventDispatcher__DelegateSignature();                                       // [Public] RVA: 0x182D96C
};
...
public:
    ...
    // --- Functions ---
    void SetSoundAttenuationScale(Character* InventoryOwner, enum AttachPosition);             // [Public] RVA: 0x182D96C
    void ReceiveChangeAttachPositionEvent(Character* OwnerCharacter, enum NewPosition);        // [Public] RVA: 0x182D96C
    void ExecuteUbergraph_BP_HeadsetsBase(int32 EntryPoint, Character* K2Node_Event_OwnerCharacter, enum K2Node_Event_NewPosition);  // [Final] RVA: 0x182D96C
};
...
public:
    ...
    // --- Functions ---
    void SetSoundAttenuationScale(Character* InventoryOwner, enum AttachPosition);             // [Protected] RVA: 0x182D96C
    void ReceiveChangeAttachPositionEvent(Character* OwnerCharacter, enum NewPosition);        // [Public] RVA: 0x182D96C
    void ExecuteUbergraph_BP_HelmetBase(int32 EntryPoint, Character* K2Node_Event_OwnerCharacter, enum K2Node_Event_NewPosition);  // [Final] RVA: 0x182D96C
};
...
public:
    ...
    // --- Functions ---
    void ExecuteUbergraph_BP_SightBase(int32 EntryPoint);                                      // [Final] RVA: 0x182D96C
};
...
public:
    ...
    // --- Functions ---
    void ExecuteUbergraph_BP_CaptureActor(int32 EntryPoint);                                   // [Final] RVA: 0x182D96C
};
...
public:
    ...
    // --- Functions ---
    bool UseBlackboard(BlackboardData* BlackboardAsset, out BlackboardComponent* BlackboardComponent);  // [Final|Public] RVA: 0x7E38E98
    void UnclaimTaskResource(TSubclassOf<GameplayTaskResource> ResourceClass);                 // [Final|Public] RVA: 0x7E38AC4
    void SetPathFollowingComponent(PathFollowingComponent* NewPFComponent);                    // [Final|Public] RVA: 0x7E38490
    void SetMoveBlockDetection(bool bEnable);                                                  // [Final|Public] RVA: 0x7E383F4
    bool RunBehaviorTree(BehaviorTree* BTAsset);                                               // [Public] RVA: 0x7E380FC
    void OnUsingBlackBoard(BlackboardComponent* BlackboardComp, BlackboardData* BlackboardAsset);  // [Protected] RVA: 0x182D96C
    void OnGameplayTaskResourcesClaimed(GameplayResourceSet NewlyClaimed, GameplayResourceSet FreshlyReleased);  // [Public] RVA: 0x7E37CE4
    uint8 MoveToLocation(const Vector Dest, float AcceptanceRadius, bool bStopOnOverlap, bool bUsePathfinding, bool bProjectDestinationToNavigation, bool bCanStrafe, TSubclassOf<NavigationQueryFilter> FilterClass, bool bAllowPartialPath);  // [Final|Public] RVA: 0x7E379C8
    uint8 MoveToActor(Actor* Goal, float AcceptanceRadius, bool bStopOnOverlap, bool bUsePathfinding, bool bCanStrafe, TSubclassOf<NavigationQueryFilter> FilterClass, bool bAllowPartialPath);  // [Final|Public] RVA: 0x7E37710
    void K2_SetFocus(Actor* NewFocus);                                                         // [Final|Public] RVA: 0x7E374B8
    void K2_SetFocalPoint(Vector FP);                                                          // [Final|Public] RVA: 0x7E37408
    void K2_ClearFocus();                                                                      // [Final|Public] RVA: 0x7E373EC
    bool HasPartialPath();                                                                     // [Final|Public] RVA: 0x7E37100
    PathFollowingComponent* GetPathFollowingComponent();                                       // [Final|Public] RVA: 0x7E36F20
    uint8 GetMoveStatus();                                                                     // [Final|Public] RVA: 0x7E36E60
    Vector GetImmediateMoveDestination();                                                      // [Final|Public] RVA: 0x7E36D18
    Actor* GetFocusActor();                                                                    // [Final|Public] RVA: 0x7E36CF4
    Vector GetFocalPointOnActor(const Actor* Actor);                                           // [Public] RVA: 0x7E36C34
    Vector GetFocalPoint();                                                                    // [Final|Public] RVA: 0x7E36C00
    AIPerceptionComponent* GetAIPerceptionComponent();                                         // [Final|Public] RVA: 0x75CE734
    void ClaimTaskResource(TSubclassOf<GameplayTaskResource> ResourceClass);                   // [Final|Public] RVA: 0x7E35FE8
};
...
public:
    ...
    // --- Functions ---
    SplineComponent* GetRailSplineComponent();                                                 // [Final|Public] RVA: 0x4798CC8
};
...
public:
    ...
    // --- Functions ---
    CineCameraComponent* GetCineCameraComponent();                                             // [Final|Public] RVA: 0x29B5944
};
...
public:
    ...
    // --- Functions ---
    void ExecuteUbergraph(int32 EntryPoint);                                                   // [Public] RVA: 0x182D96C
};
...
public:
    ...
    // --- Functions ---
    bool WasRecentlyRendered(float Tolerance);                                                 // [Final|Public] RVA: 0x7BAB8C4
    void UserConstructionScript();                                                             // [Public] RVA: 0x182D96C
    void TearOff();                                                                            // [Public] RVA: 0x537520C
    void SnapRootComponentTo(Actor* InParentActor, FName InSocketName);                        // [Final|Public] RVA: 0x7BAB7A0
    void SetTickGroup(uint8 NewTickGroup);                                                     // [Final|Public] RVA: 0x7BAB670
    void SetTickableWhenPaused(bool bTickableWhenPaused);                                      // [Final|Public] RVA: 0x7BAB704
    void SetReplicates(bool bInReplicates);                                                    // [Final|Public] RVA: 0x7BAB5D4
    void SetReplicateMovement(bool bInReplicateMovement);                                      // [Public] RVA: 0x7BAB534
    void SetOwner(Actor* NewOwner);                                                            // [Public] RVA: 0x5D55BA8
    void SetNetDormancy(uint8 NewDormancy);                                                    // [Final|Public] RVA: 0x7BAB498
    void SetLifeSpan(float InLifespan);                                                        // [Public] RVA: 0x7BAB3F8
    void SetAutoDestroyWhenFinished(bool bVal);                                                // [Final|Public] RVA: 0x7BAB35C
    void SetActorTickInterval(float TickInterval);                                             // [Final|Public] RVA: 0x7BAB2C4
    void SetActorTickEnabled(bool bEnabled);                                                   // [Final|Public] RVA: 0x22A50E0
    void SetActorScale3D(Vector NewScale3D);                                                   // [Final|Public] RVA: 0x7BAB21C
    void SetActorRelativeScale3D(Vector NewRelativeScale);                                     // [Final|Public] RVA: 0x7BAB174
    void SetActorHiddenInGame(bool bNewHidden);                                                // [Public] RVA: 0x2213EF4
    void SetActorEnableCollision(bool bNewActorEnableCollision);                               // [Final|Public] RVA: 0x28153C4
    void RemoveTickPrerequisiteComponent(ActorComponent* PrerequisiteComponent);               // [Public] RVA: 0x7BAB0D4
    void RemoveTickPrerequisiteActor(Actor* PrerequisiteActor);                                // [Public] RVA: 0x7BAB034
    void ReceiveTick(float DeltaSeconds);                                                      // [Public] RVA: 0x182D96C
    void ReceiveRadialDamage(float DamageReceived, const DamageType* DamageType, Vector Origin, const HitResult HitInfo, Controller* InstigatedBy, Actor* DamageCauser);  // [Public] RVA: 0x182D96C
    void ReceivePointDamage(float Damage, const DamageType* DamageType, Vector HitLocation, Vector HitNormal, PrimitiveComponent* HitComponent, FName BoneName, Vector ShotFromDirection, Controller* InstigatedBy, Actor* DamageCauser, const HitResult HitInfo);  // [Public] RVA: 0x182D96C
    void ReceiveHit(PrimitiveComponent* MyComp, Actor* Other, PrimitiveComponent* OtherComp, bool bSelfMoved, Vector HitLocation, Vector HitNormal, Vector NormalImpulse, const HitResult Hit);  // [Public] RVA: 0x182D96C
    void ReceiveEndPlay(uint8 EndPlayReason);                                                  // [Protected] RVA: 0x182D96C
    void ReceiveDestroyed();                                                                   // [Public] RVA: 0x182D96C
    void ReceiveBeginPlay();                                                                   // [Protected] RVA: 0x182D96C
    void ReceiveAnyDamage(float Damage, const DamageType* DamageType, Controller* InstigatedBy, Actor* DamageCauser);  // [Public] RVA: 0x182D96C
    void ReceiveActorOnReleased(Key ButtonReleased);                                           // [Public] RVA: 0x182D96C
    void ReceiveActorOnInputTouchLeave(const uint8 FingerIndex);                               // [Public] RVA: 0x182D96C
    void ReceiveActorOnInputTouchEnter(const uint8 FingerIndex);                               // [Public] RVA: 0x182D96C
    void ReceiveActorOnInputTouchEnd(const uint8 FingerIndex);                                 // [Public] RVA: 0x182D96C
    void ReceiveActorOnInputTouchBegin(const uint8 FingerIndex);                               // [Public] RVA: 0x182D96C
    void ReceiveActorOnClicked(Key ButtonPressed);                                             // [Public] RVA: 0x182D96C
    void ReceiveActorEndOverlap(Actor* OtherActor);                                            // [Public] RVA: 0x182D96C
    void ReceiveActorEndCursorOver();                                                          // [Public] RVA: 0x182D96C
    void ReceiveActorBeginOverlap(Actor* OtherActor);                                          // [Public] RVA: 0x182D96C
    void ReceiveActorBeginCursorOver();                                                        // [Public] RVA: 0x182D96C
    void PrestreamTextures(float Seconds, bool bEnableStreaming, int32 CinematicTextureGroups);  // [Public] RVA: 0x7BAAEF0
    void OnRep_ReplicateMovement();                                                            // [Public] RVA: 0x1D77234
    void OnRep_ReplicatedMovement();                                                           // [Public] RVA: 0x13AA4C4
    void OnRep_Owner();                                                                        // [Protected] RVA: 0x156F124
    void OnRep_Instigator();                                                                   // [Public] RVA: 0x20A866C
    void OnRep_AttachmentReplication();                                                        // [Public] RVA: 0x1AA7144
    void MakeNoise(float Loudness, Pawn* NoiseInstigator, Vector NoiseLocation, float MaxRange, FName Tag);  // [Final|Public] RVA: 0x7BAACF4
    MaterialInstanceDynamic* MakeMIDForMaterial(MaterialInterface* Parent);                    // [Final|Public] RVA: 0x52904C0
    bool K2_TeleportTo(Vector DestLocation, Rotator DestRotation);                             // [Final|Public] RVA: 0x7BAABD0
    bool K2_SetActorTransform(const Transform NewTransform, bool bSweep, out HitResult SweepHitResult, bool bTeleport);  // [Final|Public] RVA: 0x7BAA994
    bool K2_SetActorRotation(Rotator NewRotation, bool bTeleportPhysics);                      // [Final|Public] RVA: 0x7BAA88C
    void K2_SetActorRelativeTransform(const Transform NewRelativeTransform, bool bSweep, out HitResult SweepHitResult, bool bTeleport);  // [Final|Public] RVA: 0x7BAA65C
    void K2_SetActorRelativeRotation(Rotator NewRelativeRotation, bool bSweep, out HitResult SweepHitResult, bool bTeleport);  // [Final|Public] RVA: 0x7BAA474
    void K2_SetActorRelativeLocation(Vector NewRelativeLocation, bool bSweep, out HitResult SweepHitResult, bool bTeleport);  // [Final|Public] RVA: 0x7BAA28C
    bool K2_SetActorLocationAndRotation(Vector NewLocation, Rotator NewRotation, bool bSweep, out HitResult SweepHitResult, bool bTeleport);  // [Final|Public] RVA: 0x7BAA038
    bool K2_SetActorLocation(Vector NewLocation, bool bSweep, out HitResult SweepHitResult, bool bTeleport);  // [Final|Public] RVA: 0x7BA9E48
    void K2_OnReset();                                                                         // [Public] RVA: 0x182D96C
    void K2_OnEndViewTarget(PlayerController* PC);                                             // [Public] RVA: 0x182D96C
    void K2_OnBecomeViewTarget(PlayerController* PC);                                          // [Public] RVA: 0x182D96C
    SceneComponent* K2_GetRootComponent();                                                     // [Final|Public] RVA: 0x7BA9E24
    void K2_GetRefActorLocation(out Vector OutPosition);                                       // [Final|Public] RVA: 0x7BA9B84
    TArray<ActorComponent*> K2_GetComponentsByClass(TSubclassOf<ActorComponent> ComponentClass);  // [Final|Public] RVA: 0x7BA99EC
    Rotator K2_GetActorRotation();                                                             // [Final|Public] RVA: 0x7BA9784
    float K2_GetActorLocationZ();                                                              // [Final|Public] RVA: 0x7BA958C
    float K2_GetActorLocationY();                                                              // [Final|Public] RVA: 0x7BA938C
    float K2_GetActorLocationX();                                                              // [Final|Public] RVA: 0x7BA918C
    Vector K2_GetActorLocation();                                                              // [Final|Public] RVA: 0x1B49B60
    void K2_DetachFromActor(enum LocationRule, enum RotationRule, enum ScaleRule);             // [Final|Public] RVA: 0x7BA9038
    void K2_DestroyComponent(ActorComponent* Component);                                       // [Final|Public] RVA: 0x7BA8F98
    void K2_DestroyActor();                                                                    // [Public] RVA: 0x1BB0570
    void K2_AttachToComponent(SceneComponent* Parent, FName SocketName, enum LocationRule, enum RotationRule, enum ScaleRule, bool bWeldSimulatedBodies);  // [Final|Public] RVA: 0x7BA8D48
    void K2_AttachToActor(Actor* ParentActor, FName SocketName, enum LocationRule, enum RotationRule, enum ScaleRule, bool bWeldSimulatedBodies);  // [Final|Public] RVA: 0x7BA8B08
    void K2_AttachRootComponentToActor(Actor* InParentActor, FName InSocketName, uint8 AttachLocationType, bool bWeldSimulatedBodies);  // [Final|Public] RVA: 0x7BA8940
    void K2_AttachRootComponentTo(SceneComponent* InParent, FName InSocketName, uint8 AttachLocationType, bool bWeldSimulatedBodies);  // [Final|Public] RVA: 0x7BA8798
    void K2_AddActorWorldTransformKeepScale(const Transform DeltaTransform, bool bSweep, out HitResult SweepHitResult, bool bTeleport);  // [Final|Public] RVA: 0x7BA8568
    void K2_AddActorWorldTransform(const Transform DeltaTransform, bool bSweep, out HitResult SweepHitResult, bool bTeleport);  // [Final|Public] RVA: 0x7BA8338
    void K2_AddActorWorldRotation(Rotator DeltaRotation, bool bSweep, out HitResult SweepHitResult, bool bTeleport);  // [Final|Public] RVA: 0x7BA8150
    void K2_AddActorWorldOffset(Vector DeltaLocation, bool bSweep, out HitResult SweepHitResult, bool bTeleport);  // [Final|Public] RVA: 0x7BA7F68
    void K2_AddActorLocalTransform(const Transform NewTransform, bool bSweep, out HitResult SweepHitResult, bool bTeleport);  // [Final|Public] RVA: 0x7BA7D38
    void K2_AddActorLocalRotation(Rotator DeltaRotation, bool bSweep, out HitResult SweepHitResult, bool bTeleport);  // [Final|Public] RVA: 0x7BA7B50
    void K2_AddActorLocalOffset(Vector DeltaLocation, bool bSweep, out HitResult SweepHitResult, bool bTeleport);  // [Final|Public] RVA: 0x7BA7968
    bool IsOverlappingActor(const Actor* Other);                                               // [Final|Public] RVA: 0x7BA78C0
    bool IsChildActor();                                                                       // [Final|Public] RVA: 0x7BA784C
    bool IsActorTickEnabled();                                                                 // [Final|Public] RVA: 0x7BA7834
    bool IsActorBeingDestroyed();                                                              // [Final|Public] RVA: 0x7BA7818
    bool HasAuthority();                                                                       // [Final|Public] RVA: 0x1F76D14
    float GetVerticalDistanceTo(const Actor* OtherActor);                                      // [Final|Public] RVA: 0x7BA73A0
    Vector GetVelocity();                                                                      // [Public] RVA: 0x7BA7368
    Transform GetTransform();                                                                  // [Final|Public] RVA: 0x7BA710C
    bool GetTickableWhenPaused();                                                              // [Final|Public] RVA: 0x7BA70F4
    float GetSquaredDistanceTo(const Actor* OtherActor);                                       // [Final|Public] RVA: 0x7BA7048
    uint8 GetRemoteRole();                                                                     // [Final|Public] RVA: 0x4DDE830
    ChildActorComponent* GetParentComponent();                                                 // [Final|Public] RVA: 0x7BA6FB4
    Actor* GetParentActor();                                                                   // [Final|Public] RVA: 0x7BA6F90
    Actor* GetOwner();                                                                         // [Final|Public] RVA: 0x29B570C
    void GetOverlappingComponents(out TArray<PrimitiveComponent*> OverlappingComponents);      // [Final|Public] RVA: 0x7BA6E54
    void GetOverlappingActors(out TArray<Actor*> OverlappingActors, TSubclassOf<Actor> ClassFilter);  // [Final|Public] RVA: 0x7BA6D44
    uint8 GetLocalRole();                                                                      // [Final|Public] RVA: 0x231BF48
    float GetLifeSpan();                                                                       // [Public] RVA: 0x7BA6D18
    Controller* GetInstigatorController();                                                     // [Final|Public] RVA: 0x7BA6CF8
    Pawn* GetInstigator();                                                                     // [Final|Public] RVA: 0x5E04600
    Vector GetInputVectorAxisValue(const Key InputAxisKey);                                    // [Final|Public] RVA: 0x7BA6B9C
    float GetInputAxisValue(const FName InputAxisName);                                        // [Final|Public] RVA: 0x7BA69D8
    float GetInputAxisKeyValue(const Key InputAxisKey);                                        // [Final|Public] RVA: 0x7BA688C
    float GetHorizontalDotProductTo(const Actor* OtherActor);                                  // [Final|Public] RVA: 0x7BA62B0
    float GetHorizontalDistanceTo(const Actor* OtherActor);                                    // [Final|Public] RVA: 0x7BA5E14
    float GetGameTimeSinceCreation();                                                          // [Final|Public] RVA: 0x7BA5DEC
    float GetDotProductTo(const Actor* OtherActor);                                            // [Final|Public] RVA: 0x7BA57F8
    float GetDistanceTo(const Actor* OtherActor);                                              // [Final|Public] RVA: 0x7BA574C
    TArray<ActorComponent*> GetComponentsByTag(TSubclassOf<ActorComponent> ComponentClass, FName Tag);  // [Final|Public] RVA: 0x7BA5564
    TArray<ActorComponent*> GetComponentsByInterface(TSubclassOf<Interface> Interface);        // [Final|Public] RVA: 0x7BA53CC
    ActorComponent* GetComponentByInterface(TSubclassOf<Interface> Interface);                 // [Final|Public] RVA: 0x7BA5324
    ActorComponent* GetComponentByClass(TSubclassOf<ActorComponent> ComponentClass);           // [Final|Public] RVA: 0x1B2EBC0
    FName GetAttachParentSocketName();                                                         // [Final|Public] RVA: 0x7BA52F8
    Actor* GetAttachParentActor();                                                             // [Final|Public] RVA: 0x7BA52D8
    void GetAttachedActors(out TArray<Actor*> OutActors, bool bResetArray);                    // [Final|Public] RVA: 0x144C928
    void GetAllChildActors(out TArray<Actor*> ChildActors, bool bIncludeDescendants);          // [Final|Public] RVA: 0x7BA51C8
    Vector GetActorUpVector();                                                                 // [Final|Public] RVA: 0x7BA5164
    float GetActorTimeDilation();                                                              // [Final|Public] RVA: 0x7BA513C
    float GetActorTickInterval();                                                              // [Final|Public] RVA: 0x29AE128
    Vector GetActorScale3D();                                                                  // [Final|Public] RVA: 0x7BA5108
    Vector GetActorRightVector();                                                              // [Final|Public] RVA: 0x7BA50A4
    Vector GetActorRelativeScale3D();                                                          // [Final|Public] RVA: 0x7BA5074
    Vector GetActorForwardVector();                                                            // [Final|Public] RVA: 0x7BA5010
    void GetActorEyesViewPoint(out Vector OutLocation, out Rotator OutRotation);               // [Public] RVA: 0x7BA4ED8
    bool GetActorEnableCollision();                                                            // [Final|Public] RVA: 0x7BA4EBC
    void GetActorBounds(bool bOnlyCollidingComponents, out Vector Origin, out Vector BoxExtent, bool bIncludeFromChildActors);  // [Final|Public] RVA: 0x7BA4CA8
    void ForceNetUpdate();                                                                     // [Public] RVA: 0x5E3B5D4
    void FlushNetDormancy();                                                                   // [Final|Public] RVA: 0x7BA4C94
    void FinishAddComponent(ActorComponent* Component, bool bManualAttachment, const Transform RelativeTransform);  // [Final|Public] RVA: 0x7BA49C4
    void EnableInput(PlayerController* PlayerController);                                      // [Public] RVA: 0x689D8A4
    void DisableInput(PlayerController* PlayerController);                                     // [Public] RVA: 0x689DB64
    void DetachRootComponentFromParent(bool bMaintainWorldPosition);                           // [Final|Public] RVA: 0x7BA4928
    void AddTickPrerequisiteComponent(ActorComponent* PrerequisiteComponent);                  // [Public] RVA: 0x7BA4888
    void AddTickPrerequisiteActor(Actor* PrerequisiteActor);                                   // [Public] RVA: 0x7BA47E8
    ActorComponent* AddComponentByClass(TSubclassOf<ActorComponent> Class, bool bManualAttachment, const Transform RelativeTransform, bool bDeferredFinish);  // [Final|Public] RVA: 0x7BA4558
    ActorComponent* AddComponent(FName TemplateName, bool bManualAttachment, const Transform RelativeTransform, const Object* ComponentTemplateContext, bool bDeferredFinish);  // [Final|Public] RVA: 0x1CDA928
    bool ActorHasTag(FName Tag);                                                               // [Final|Public] RVA: 0x7BA44B0
    void ActiveManualReplicate();                                                              // [Final|Public] RVA: 0x7BA4498
};
...
public:
    ...
    // --- Functions ---
    FString GetLayerSpecDescription(const TArray<float> LayerSpec);                            // [Final|Public] RVA: 0x7BBA1D4
    void GetDefaultParameters(out TArray<AutoColorGradingData> outParameters);                 // [Final|Public] RVA: 0x7BBA138
    void GetCurrentPositionAndDiff(out float OutPosition, out float outDiff);                  // [Final|Public] RVA: 0x7BBA034
    void FeedLayerSpecParams(const TArray<float> LayerSpec);                                   // [Final|Public] RVA: 0x7BB9EF4
    void EnableAutoColorGrading(bool bEnable);                                                 // [Final|Public] RVA: 0x7BB9E58
};
...
public:
    ...
    // --- Functions ---
    int32 GetAutoActivatePlayerIndex();                                                        // [Final|Public] RVA: 0x7BC5CFC
};
...
public:
    ...
    // --- Functions ---
    void UnCrouch(bool bClientSimulation);                                                     // [Public] RVA: 0x5CC4248
    void StopJumping();                                                                        // [Public] RVA: 0x5E3B480
    void StopAnimMontage(AnimMontage* AnimMontage);                                            // [Public] RVA: 0x7BCF6D4
    void ServerMovePacked(const CharacterServerMovePackedBits PackedBits);                     // [Public] RVA: 0x7BCEF0C
    void ServerMoveOld(float OldTimeStamp, Vector_NetQuantize10 OldAccel, MovementCompressedFlags OldMoveFlags);  // [Public] RVA: 0x7BCED74
    void ServerMoveNoBase(float Timestamp, Vector_NetQuantize10 InAccel, Vector_NetQuantize100 ClientLoc, MovementCompressedFlags CompressedMoveFlags, uint8 ClientRoll, uint32 View, uint8 ClientMovementMode);  // [Public] RVA: 0x7BCEA58
    void ServerMoveDualNoBase(float TimeStamp0, Vector_NetQuantize10 InAccel0, MovementCompressedFlags PendingFlags, uint32 View0, float Timestamp, Vector_NetQuantize10 InAccel, Vector_NetQuantize100 ClientLoc, MovementCompressedFlags NewFlags, uint8 ClientRoll, uint32 View, uint8 ClientMovementMode);  // [Public] RVA: 0x7BCE5A0
    void ServerMoveDualHybridRootMotion(float TimeStamp0, Vector_NetQuantize10 InAccel0, MovementCompressedFlags PendingFlags, uint32 View0, float Timestamp, Vector_NetQuantize10 InAccel, Vector_NetQuantize100 ClientLoc, MovementCompressedFlags NewFlags, uint8 ClientRoll, uint32 View, PrimitiveComponent* ClientMovementBase, FName ClientBaseBoneName, uint8 ClientMovementMode);  // [Public] RVA: 0x7BCE02C
    void ServerMoveDual(float TimeStamp0, Vector_NetQuantize10 InAccel0, MovementCompressedFlags PendingFlags, uint32 View0, float Timestamp, Vector_NetQuantize10 InAccel, Vector_NetQuantize100 ClientLoc, MovementCompressedFlags NewFlags, uint8 ClientRoll, uint32 View, PrimitiveComponent* ClientMovementBase, FName ClientBaseBoneName, uint8 ClientMovementMode);  // [Public] RVA: 0x7BCDAB8
    void ServerMove(float Timestamp, Vector_NetQuantize10 InAccel, Vector_NetQuantize100 ClientLoc, MovementCompressedFlags CompressedMoveFlags, uint8 ClientRoll, uint32 View, PrimitiveComponent* ClientMovementBase, FName ClientBaseBoneName, uint8 ClientMovementMode);  // [Public] RVA: 0x7BCD6DC
    void RootMotionDebugClientPrintOnScreen(FString inString);                                 // [Public] RVA: 0x7BCD5DC
    bool PreGetCachedMoveOverlapsShapes(const Transform NewTransform, const Transform OldTransform, bool bRealMove, bool SweepOrLineTrace);  // [Final|Public] RVA: 0x7BCD3A4
    float PlayAnimMontage(AnimMontage* AnimMontage, float InPlayRate, FName StartSectionName);  // [Public] RVA: 0x7BCD25C
    void OnWalkingOffLedge(const Vector PreviousFloorImpactNormal, const Vector PreviousFloorContactNormal, const Vector PreviousLocation, float TimeDelta);  // [Public] RVA: 0x22604A4
    void OnRep_RootMotion();                                                                   // [Final|Public] RVA: 0x1BF42CC
    void OnRep_ReplicatedBasedMovement();                                                      // [Public] RVA: 0x1785354
    void OnRep_ReplayLastTransformUpdateTimeStamp();                                           // [Final|Public] RVA: 0x19DE6F8
    void OnRep_IsCrouched();                                                                   // [Public] RVA: 0x277650C
    void OnLaunched(Vector LaunchVelocity, bool bXYOverride, bool bZOverride);                 // [Public] RVA: 0x182D96C
    void OnLanded(const HitResult Hit);                                                        // [Public] RVA: 0x182D96C
    void OnJumped();                                                                           // [Public] RVA: 0x7BCD244
    void LaunchCharacter(Vector LaunchVelocity, bool bXYOverride, bool bZOverride);            // [Public] RVA: 0x7BCD0EC
    void K2_UpdateCustomMovement(float DeltaTime);                                             // [Public] RVA: 0x182D96C
    void K2_OnStartCrouch(float HalfHeightAdjust, float ScaledHalfHeightAdjust);               // [Public] RVA: 0x182D96C
    void K2_OnMovementModeChanged(uint8 PrevMovementMode, uint8 NewMovementMode, uint8 PrevCustomMode, uint8 NewCustomMode);  // [Public] RVA: 0x182D96C
    void K2_OnEndCrouch(float HalfHeightAdjust, float ScaledHalfHeightAdjust);                 // [Public] RVA: 0x182D96C
    void Jump();                                                                               // [Public] RVA: 0x7BCB040
    bool IsPlayingRootMotion();                                                                // [Final|Public] RVA: 0x7BCB01C
    bool IsPlayingNetworkedRootMotionMontage();                                                // [Final|Public] RVA: 0x7BCAFF8
    bool IsJumpProvidingForce();                                                               // [Public] RVA: 0x7BCAFD0
    bool HasAnyRootMotion();                                                                   // [Final|Public] RVA: 0x7BCAF98
    AnimMontage* GetCurrentMontage();                                                          // [Final|Public] RVA: 0x7BC992C
    Vector GetBaseTranslationOffset();                                                         // [Final|Public] RVA: 0x7BC9904
    Rotator GetBaseRotationOffsetRotator();                                                    // [Final|Public] RVA: 0x7BC98D0
    float GetAnimRootMotionTranslationScale();                                                 // [Final|Public] RVA: 0x7BC97DC
    void Crouch(bool bClientSimulation);                                                       // [Public] RVA: 0x7BC973C
    void ClientVeryShortAdjustPosition(float Timestamp, Vector NewLoc, PrimitiveComponent* NewBase, FName NewBaseBoneName, bool bHasBase, bool bBaseRelativePosition, uint8 ServerMovementMode);  // [Public] RVA: 0x7BC9260
    void ClientMoveResponsePacked(const CharacterMoveResponsePackedBits PackedBits);           // [Public] RVA: 0x7BC9104
    void ClientCheatWalk();                                                                    // [Public] RVA: 0x7BC90EC
    void ClientCheatGhost();                                                                   // [Public] RVA: 0x7BC90D4
    void ClientCheatFly();                                                                     // [Public] RVA: 0x7BC90BC
    void ClientAdjustRootMotionSourcePosition(float Timestamp, RootMotionSourceGroup ServerRootMotion, bool bHasAnimRootMotion, float ServerMontageTrackPosition, Vector ServerLoc, Vector_NetQuantizeNormal ServerRotation, float ServerVelZ, PrimitiveComponent* ServerBase, FName ServerBoneName, bool bHasBase, bool bBaseRelativePosition, uint8 ServerMovementMode);  // [Public] RVA: 0x7BC8BD4
    void ClientAdjustRootMotionPosition(float Timestamp, float ServerMontageTrackPosition, Vector ServerLoc, Vector_NetQuantizeNormal ServerRotation, float ServerVelZ, PrimitiveComponent* ServerBase, FName ServerBoneName, bool bHasBase, bool bBaseRelativePosition, uint8 ServerMovementMode);  // [Public] RVA: 0x7BC880C
    void ClientAdjustPosition(float Timestamp, Vector NewLoc, Vector NewVel, PrimitiveComponent* NewBase, FName NewBaseBoneName, bool bHasBase, bool bBaseRelativePosition, uint8 ServerMovementMode, uint8 ServerSprintFailReason);  // [Public] RVA: 0x7BC849C
    void ClientAckGoodMove(float Timestamp);                                                   // [Public] RVA: 0x7BC83F8
    bool CanJumpInternal();                                                                    // [Protected] RVA: 0x7BC83D0
    bool CanJump();                                                                            // [Final|Public] RVA: 0x7BC836C
    bool CanCrouch();                                                                          // [Public] RVA: 0x279D9CC
    void CacheInitialMeshOffset(Vector MeshRelativeLocation, Rotator MeshRelativeRotation);    // [Public] RVA: 0x7BC8254
};
...
public:
    ...
    // --- Functions ---
    void UnPossess();                                                                          // [Final|Public] RVA: 0x7BD2E9C
    void StopMovement();                                                                       // [Public] RVA: 0x5D67210
    void SetInitialLocationAndRotation(const Vector NewLocation, const Rotator NewRotation);   // [Public] RVA: 0x5E4F9B0
    void SetIgnoreMoveInput(bool bNewMoveInput);                                               // [Public] RVA: 0x7BD2DFC
    void SetIgnoreLookInput(bool bNewLookInput);                                               // [Public] RVA: 0x7BD2D5C
    void SetControlRotation(const Rotator NewRotation);                                        // [Public] RVA: 0x7BD2CBC
    void ResetIgnoreMoveInput();                                                               // [Public] RVA: 0x4788968
    void ResetIgnoreLookInput();                                                               // [Public] RVA: 0x5E58614
    void ResetIgnoreInputFlags();                                                              // [Public] RVA: 0x2206644
    void ReceiveUnPossess(Pawn* UnpossessedPawn);                                              // [Protected] RVA: 0x182D96C
    void ReceivePossess(Pawn* PossessedPawn);                                                  // [Protected] RVA: 0x182D96C
    void ReceiveInstigatedAnyDamage(float Damage, const DamageType* DamageType, Actor* DamagedActor, Actor* DamageCauser);  // [Protected] RVA: 0x182D96C
    void Possess(Pawn* InPawn);                                                                // [Final|Public] RVA: 0x7BD2C20
    void OnRep_PlayerState();                                                                  // [Public] RVA: 0xFA0EC8
    void OnRep_Pawn();                                                                         // [Public] RVA: 0xFA0EA4
    bool LineOfSightTo(const Actor* Other, Vector ViewPoint, bool bAlternateChecks);           // [Public] RVA: 0x7BD2AC8
    Pawn* K2_GetPawn();                                                                        // [Final|Public] RVA: 0x29B6080
    bool IsPlayerController();                                                                 // [Final|Public] RVA: 0x7BD2AAC
    bool IsMoveInputIgnored();                                                                 // [Public] RVA: 0x7BD2A84
    bool IsLookInputIgnored();                                                                 // [Public] RVA: 0x7BD2A5C
    bool IsLocalPlayerController();                                                            // [Final|Public] RVA: 0x7BD2A18
    bool IsLocalController();                                                                  // [Public] RVA: 0x7BD29F0
    Actor* GetViewTarget();                                                                    // [Public] RVA: 0x226BC4C
    Rotator GetDesiredRotation();                                                              // [Public] RVA: 0x7BD27B0
    Rotator GetControlRotation();                                                              // [Public] RVA: 0x7BD2778
    void ClientSetRotation(Rotator NewRotation, bool bResetCamera);                            // [Public] RVA: 0x22B8990
    void ClientSetLocation(Vector NewLocation, Rotator NewRotation);                           // [Public] RVA: 0x7BD2620
    PlayerController* CastToPlayerController();                                                // [Final|Public] RVA: 0x7BD25D8
};
...
public:
    ...
    // --- Functions ---
    void StartMatch();                                                                         // [Public] RVA: 0x5ED191C
    void SetBandwidthLimit(float AsyncIOBandwidthLimit);                                       // [Public] RVA: 0x5E7ED34
    void Say(FString Msg);                                                                     // [Public] RVA: 0x7BE6870
    void RestartGame();                                                                        // [Public] RVA: 0x5ED194C
    bool ReadyToStartMatch();                                                                  // [Protected] RVA: 0x22A725C
    bool ReadyToEndMatch();                                                                    // [Protected] RVA: 0x1CC5360
    bool NeedBlockLoadLevelWhenStartMatch();                                                   // [Protected] RVA: 0x279D9CC
    void K2_OnSetMatchState(FName NewState);                                                   // [Protected] RVA: 0x182D96C
    bool IsMatchInProgress();                                                                  // [Public] RVA: 0x7BE34CC
    FName GetMatchState();                                                                     // [Final|Public] RVA: 0x7BE22DC
    void EndMatch();                                                                           // [Public] RVA: 0x5ED1934
    void AbortMatch();                                                                         // [Public] RVA: 0x5ED17B4
};
...
public:
    ...
    // --- Functions ---
    void StartPlay();                                                                          // [Public] RVA: 0x1B1C670
    Pawn* SpawnDefaultPawnFor(Controller* NewPlayer, Actor* StartSpot);                        // [Public] RVA: 0x278EDA0
    Pawn* SpawnDefaultPawnAtTransform(Controller* NewPlayer, const Transform SpawnTransform);  // [Public] RVA: 0x2815628
    bool ShouldReset(Actor* ActorToReset);                                                     // [Public] RVA: 0x7BE7CC8
    void ReturnToMainMenuHost();                                                               // [Public] RVA: 0x5C60D4C
    void RestartPlayerAtTransform(Controller* NewPlayer, const Transform SpawnTransform);      // [Public] RVA: 0x7BE65E8
    void RestartPlayerAtPlayerStart(Controller* NewPlayer, Actor* StartSpot);                  // [Public] RVA: 0x7BE64FC
    void RestartPlayer(Controller* NewPlayer);                                                 // [Public] RVA: 0x5CC51FC
    void ResetLevel();                                                                         // [Public] RVA: 0x29B7FFC
    bool PlayerCanRestart(PlayerController* Player);                                           // [Public] RVA: 0x1BB3848
    bool MustSpectate(PlayerController* NewPlayerController);                                  // [Public] RVA: 0x20A2980
    void K2_PostLogin(PlayerController* NewPlayer);                                            // [Public] RVA: 0x182D96C
    void K2_OnSwapPlayerControllers(PlayerController* OldPC, PlayerController* NewPC);         // [Protected] RVA: 0x182D96C
    void K2_OnRestartPlayer(Controller* NewPlayer);                                            // [Public] RVA: 0x182D96C
    void K2_OnLogout(Controller* ExitingController);                                           // [Public] RVA: 0x182D96C
    void K2_OnChangeName(Controller* Other, FString NewName, bool bNameChange);                // [Public] RVA: 0x182D96C
    Actor* K2_FindPlayerStart(Controller* Player, FString IncomingName);                       // [Final|Public] RVA: 0x7BE35BC
    void InitStartSpot(Actor* StartSpot, Controller* NewPlayer);                               // [Public] RVA: 0x29B79B0
    void InitializeHUDForPlayer(PlayerController* NewPlayer);                                  // [Protected] RVA: 0x22CCF28
    bool HasMatchStarted();                                                                    // [Public] RVA: 0x7BD29F0
    bool HasMatchEnded();                                                                      // [Public] RVA: 0x5C604AC
    void HandleStartingNewPlayer(PlayerController* NewPlayer);                                 // [Public] RVA: 0x1BB2660
    int32 GetNumSpectators();                                                                  // [Public] RVA: 0x7BE23B4
    int32 GetNumPlayers();                                                                     // [Public] RVA: 0x7BE238C
    TSubclassOf<Object> GetDefaultPawnClassForController(Controller* InController);            // [Public] RVA: 0x22683F0
    Actor* FindPlayerStart(Controller* Player, FString IncomingName);                          // [Public] RVA: 0x204D254
    Actor* ChoosePlayerStart(Controller* Player);                                              // [Public] RVA: 0x1BB25B0
    void ChangeName(Controller* Controller, FString NewName, bool bNameChange);                // [Public] RVA: 0x7BDF3D4
    bool CanSpectate(PlayerController* Viewer, PlayerState* ViewTarget);                       // [Public] RVA: 0x7BDF2C0
};
...
public:
    ...
    // --- Functions ---
    void OnRep_MatchState();                                                                   // [Public] RVA: 0x29ADF00
    void OnRep_ElapsedTime();                                                                  // [Public] RVA: 0x29B7FFC
};
...
public:
    ...
    // --- Functions ---
    void OnRep_SpectatorClass();                                                               // [Protected] RVA: 0xFA0EC8
    void OnRep_ReplicatedWorldTimeSeconds();                                                   // [Protected] RVA: 0x1B1C670
    void OnRep_ReplicatedHasBegunPlay();                                                       // [Protected] RVA: 0x2319F58
    void OnRep_GameModeClass();                                                                // [Protected] RVA: 0xFA0EA4
    bool HasMatchStarted();                                                                    // [Public] RVA: 0x49AF2C8
    bool HasMatchEnded();                                                                      // [Public] RVA: 0x5DCD23C
    bool HasBegunPlay();                                                                       // [Public] RVA: 0x7BEC6EC
    float GetServerWorldTimeSeconds();                                                         // [Public] RVA: 0x7BEC688
    float GetPlayerStartTime(Controller* Controller);                                          // [Public] RVA: 0x7BEC190
    float GetPlayerRespawnDelay(Controller* Controller);                                       // [Public] RVA: 0x7BEC0E0
};
...
public:
    ...
    // --- Functions ---
    void ShowHUD();                                                                            // [Public] RVA: 0x1C0B120
    void ShowDebugToggleSubCategory(FName Category);                                           // [Final|Public] RVA: 0x7BF0BC0
    void ShowDebugForReticleTargetToggle(TSubclassOf<Actor> DesiredClass);                     // [Final|Public] RVA: 0x7BF0B20
    void ShowDebug(FName DebugType);                                                           // [Public] RVA: 0x7BF0A84
    void RemoveDebugText(Actor* SrcActor, bool bLeaveDurationText);                            // [Final|Public] RVA: 0x7BF07B4
    void RemoveAllDebugStrings();                                                              // [Final|Public] RVA: 0x7BF0798
    void ReceiveHitBoxRelease(const FName BoxName);                                            // [Public] RVA: 0x182D96C
    void ReceiveHitBoxEndCursorOver(const FName BoxName);                                      // [Public] RVA: 0x182D96C
    void ReceiveHitBoxClick(const FName BoxName);                                              // [Public] RVA: 0x182D96C
    void ReceiveHitBoxBeginCursorOver(const FName BoxName);                                    // [Public] RVA: 0x182D96C
    void ReceiveDrawHUD(int32 SizeX, int32 SizeY);                                             // [Public] RVA: 0x182D96C
    Vector Project(Vector Location);                                                           // [Final|Public] RVA: 0x7BF06D0
    void PreviousDebugTarget();                                                                // [Public] RVA: 0x5C60494
    void NextDebugTarget();                                                                    // [Public] RVA: 0x2319F58
    void GetTextSize(FString Text, out float OutWidth, out float OutHeight, Font* Font, float Scale);  // [Final|Public] RVA: 0x7BF035C
    PlayerController* GetOwningPlayerController();                                             // [Final|Public] RVA: 0x4FAAE2C
    Pawn* GetOwningPawn();                                                                     // [Final|Public] RVA: 0x7BF033C
    void GetActorsInSelectionRectangle(TSubclassOf<Actor> ClassFilter, const Vector2D FirstPoint, const Vector2D SecondPoint, out TArray<Actor*> OutActors, bool bIncludeNonCollidingComponents, bool bActorMustBeFullyEnclosed);  // [Final|Public] RVA: 0x7BF0064
    void DrawTextureSimple(Texture* Texture, float ScreenX, float ScreenY, float Scale, bool bScalePosition);  // [Final|Public] RVA: 0x7BEFDD4
    void DrawTexture(Texture* Texture, float ScreenX, float ScreenY, float ScreenW, float ScreenH, float TextureU, float TextureV, float TextureUWidth, float TextureVHeight, LinearColor TintColor, uint8 BlendMode, float Scale, bool bScalePosition, float Rotation, Vector2D RotPivot);  // [Final|Public] RVA: 0x7BEF700
    void DrawText(FString Text, LinearColor TextColor, float ScreenX, float ScreenY, Font* Font, float Scale, bool bScalePosition);  // [Final|Public] RVA: 0x7BEF44C
    void DrawRect(LinearColor RectColor, float ScreenX, float ScreenY, float ScreenW, float ScreenH);  // [Final|Public] RVA: 0x7BEF254
    void DrawMaterialTriangle(MaterialInterface* Material, Vector2D V0_Pos, Vector2D V1_Pos, Vector2D V2_Pos, Vector2D V0_UV, Vector2D V1_UV, Vector2D V2_UV, LinearColor V0_Color, LinearColor V1_Color, LinearColor V2_Color);  // [Final|Public] RVA: 0x7BEEDBC
    void DrawMaterialSimple(MaterialInterface* Material, float ScreenX, float ScreenY, float ScreenW, float ScreenH, float Scale, bool bScalePosition);  // [Final|Public] RVA: 0x7BEEA54
    void DrawMaterial(MaterialInterface* Material, float ScreenX, float ScreenY, float ScreenW, float ScreenH, float MaterialU, float MaterialV, float MaterialUWidth, float MaterialVHeight, float Scale, bool bScalePosition, float Rotation, Vector2D RotPivot);  // [Final|Public] RVA: 0x7BEE41C
    void DrawLine(float StartScreenX, float StartScreenY, float EndScreenX, float EndScreenY, LinearColor LineColor, float LineThickness);  // [Final|Public] RVA: 0x7BEE1D0
    void Deproject(float ScreenX, float ScreenY, out Vector WorldPosition, out Vector WorldDirection);  // [Final|Public] RVA: 0x7BEDFD0
    void AddHitBox(Vector2D position, Vector2D Size, FName InName, bool bConsumesInput, int32 Priority);  // [Final|Public] RVA: 0x7BEDDEC
    void AddDebugText(FString DebugText, Actor* SrcActor, float Duration, Vector Offset, Vector DesiredOffset, Color TextColor, bool bSkipOverwriteCheck, bool bAbsoluteLocation, bool bKeepAttachedToActor, Font* InFont, float FontScale, bool bDrawShadow);  // [Final|Public] RVA: 0x7BED964
};
...
public:
    ...
    // --- Functions ---
    void WorldOriginLocationChanged(IntVector OldOriginLocation, IntVector NewOriginLocation);  // [Public] RVA: 0x182D96C
    void SetCinematicMode(bool bCinematicMode, bool bHidePlayer, bool bAffectsHUD, bool bAffectsMovement, bool bAffectsTurning);  // [Public] RVA: 0x7C50404
    bool RemoteEvent(FName EventName);                                                         // [Public] RVA: 0x7C4FB68
    void LevelReset();                                                                         // [Public] RVA: 0x182D96C
};
...
public:
    ...
    // --- Functions ---
    void SpawnDefaultController();                                                             // [Public] RVA: 0x5C60B9C
    void SetCanAffectNavigationGeneration(bool bNewValue, bool bForceUpdate);                  // [Final|Public] RVA: 0x7C5E890
    void ReceiveUnpossessed(Controller* OldController);                                        // [Public] RVA: 0x182D96C
    void ReceivePossessed(Controller* NewController);                                          // [Public] RVA: 0x182D96C
    void PawnMakeNoise(float Loudness, Vector NoiseLocation, bool bUseNoiseMakerLocation, Actor* NoiseMaker);  // [Final|Public] RVA: 0x7C5DBEC
    void OnRep_PlayerState();                                                                  // [Public] RVA: 0x1C6C308
    void OnRep_Controller();                                                                   // [Public] RVA: 0x5C60018
    void LaunchPawn(Vector LaunchVelocity, bool bXYOverride, bool bZOverride);                 // [Final|Public] RVA: 0x7C5D8F8
    Vector K2_GetMovementInputVector();                                                        // [Final|Public] RVA: 0x7C5D75C
    bool IsPlayerControlled();                                                                 // [Public] RVA: 0x7BD29F0
    bool IsPawnControlled();                                                                   // [Final|Public] RVA: 0x7C5D8A8
    bool IsMoveInputIgnored();                                                                 // [Public] RVA: 0x7C5D880
    bool IsLocallyControlled();                                                                // [Public] RVA: 0x7C5D858
    bool IsControlled();                                                                       // [Final|Public] RVA: 0x7C5D800
    bool IsBotControlled();                                                                    // [Public] RVA: 0x5C604AC
    Vector GetPendingMovementInputVector();                                                    // [Final|Public] RVA: 0x7C5D75C
    Vector GetNavAgentLocation();                                                              // [Public] RVA: 0x7C5D6D8
    PawnMovementComponent* GetMovementComponent();                                             // [Public] RVA: 0x7BD4944
    Actor* GetMovementBaseActor(const Pawn* Pawn);                                             // [Static|Final|Public] RVA: 0x7C5D640
    Vector GetLastMovementInputVector();                                                       // [Final|Public] RVA: 0x7C5D618
    Rotator GetControlRotation();                                                              // [Final|Public] RVA: 0x7C5D518
    Controller* GetController();                                                               // [Final|Public] RVA: 0x5E343AC
    Rotator GetBaseAimRotation();                                                              // [Public] RVA: 0x7C5D228
    void DetachFromControllerPendingDestroy();                                                 // [Public] RVA: 0x5C60FCC
    Vector ConsumeMovementInputVector();                                                       // [Public] RVA: 0x7C5D1F0
    void AddMovementInput(Vector WorldDirection, float ScaleValue, bool bForce);               // [Public] RVA: 0x7C5CC4C
    void AddControllerYawInput(float Val);                                                     // [Public] RVA: 0x5C60844
    void AddControllerRollInput(float Val);                                                    // [Public] RVA: 0x5C60F14
    void AddControllerPitchInput(float Val);                                                   // [Public] RVA: 0x5C607A4
};
...
public:
    ...
    // --- Functions ---
    void SwapPendingViewTargetWhenUsingClientSideCameraUpdates();                              // [Final|Protected] RVA: 0x7C6B41C
    void StopCameraShake(CameraShakeBase* ShakeInstance, bool bImmediately);                   // [Public] RVA: 0x7C6B28C
    void StopCameraFade();                                                                     // [Public] RVA: 0x1B0297C
    void StopCameraAnimInst(CameraAnimInst* AnimInst, bool bImmediate);                        // [Public] RVA: 0x7C6B19C
    void StopAllInstancesOfCameraShakeFromSource(TSubclassOf<CameraShakeBase> Shake, CameraShakeSourceComponent* SourceComponent, bool bImmediately);  // [Public] RVA: 0x7C6B064
    void StopAllInstancesOfCameraShake(TSubclassOf<CameraShakeBase> Shake, bool bImmediately);  // [Public] RVA: 0x7C6AF74
    void StopAllInstancesOfCameraAnim(CameraAnim* Anim, bool bImmediate);                      // [Public] RVA: 0x7C6AE84
    void StopAllCameraShakesFromSource(CameraShakeSourceComponent* SourceComponent, bool bImmediately);  // [Public] RVA: 0x7C6AD94
    void StopAllCameraShakes(bool bImmediately);                                               // [Public] RVA: 0x7C6ACF4
    void StopAllCameraAnims(bool bImmediate);                                                  // [Public] RVA: 0x7C6AC54
    MatineeCameraShake* StartMatineeCameraShakeFromSource(TSubclassOf<MatineeCameraShake> ShakeClass, CameraShakeSourceComponent* SourceComponent, float Scale, enum PlaySpace, Rotator UserPlaySpaceRot);  // [Final|Public] RVA: 0x7C6AA58
    MatineeCameraShake* StartMatineeCameraShake(TSubclassOf<MatineeCameraShake> ShakeClass, float Scale, enum PlaySpace, Rotator UserPlaySpaceRot);  // [Final|Public] RVA: 0x7C6A8B0
    CameraShakeBase* StartCameraShakeFromSource(TSubclassOf<CameraShakeBase> ShakeClass, CameraShakeSourceComponent* SourceComponent, float Scale, enum PlaySpace, Rotator UserPlaySpaceRot);  // [Public] RVA: 0x7C6A620
    CameraShakeBase* StartCameraShake(TSubclassOf<CameraShakeBase> ShakeClass, float Scale, enum PlaySpace, Rotator UserPlaySpaceRot);  // [Public] RVA: 0x7C6A474
    void StartCameraFade(float FromAlpha, float ToAlpha, float Duration, LinearColor Color, bool bShouldFadeAudio, bool bHoldWhenFinished);  // [Public] RVA: 0x7C6A228
    void SetManualCameraFade(float InFadeAmount, LinearColor Color, bool bInFadeAudio);        // [Public] RVA: 0x7C69A8C
    void SetGameCameraCutThisFrame();                                                          // [Final|Public] RVA: 0x7C69934
    bool RemoveCameraModifier(CameraModifier* ModifierToRemove);                               // [Public] RVA: 0x6863B48
    void RemoveCameraLensEffect(EmitterCameraLensEffectBase* Emitter);                         // [Public] RVA: 0x7C683B8
    CameraAnimInst* PlayCameraAnim(CameraAnim* Anim, float Rate, float Scale, float BlendInTime, float BlendOutTime, bool bLoop, bool bRandomStartTime, float Duration, enum PlaySpace, Rotator UserPlaySpaceRot);  // [Public] RVA: 0x7C6754C
    void PhotographyCameraModify(const Vector NewCameraLocation, const Vector PreviousCameraLocation, const Vector OriginalCameraLocation, out Vector ResultCameraLocation);  // [Public] RVA: 0x7C67344
    void OnPhotographySessionStart();                                                          // [Public] RVA: 0x231BF30
    void OnPhotographySessionEnd();                                                            // [Public] RVA: 0x469295C
    void OnPhotographyMultiPartCaptureStart();                                                 // [Public] RVA: 0x1EF4B40
    void OnPhotographyMultiPartCaptureEnd();                                                   // [Public] RVA: 0x1C0B120
    PlayerController* GetOwningPlayerController();                                             // [Public] RVA: 0x7C66CEC
    float GetFOVAngle();                                                                       // [Public] RVA: 0x7BD0434
    Rotator GetCameraRotation();                                                               // [Public] RVA: 0x7C6572C
    Vector GetCameraLocation();                                                                // [Public] RVA: 0x7C656F4
    CameraModifier* FindCameraModifierByClass(TSubclassOf<CameraModifier> ModifierClass);      // [Public] RVA: 0x7C65644
    void ClearCameraLensEffects();                                                             // [Public] RVA: 0x277650C
    bool BlueprintUpdateCamera(Actor* CameraTarget, out Vector NewCameraLocation, out Rotator NewCameraRotation, out float NewCameraFOV);  // [Public] RVA: 0x182D96C
    CameraModifier* AddNewCameraModifier(TSubclassOf<CameraModifier> ModifierClass);           // [Public] RVA: 0x7C62158
    EmitterCameraLensEffectBase* AddCameraLensEffect(TSubclassOf<EmitterCameraLensEffectBase> LensEffectEmitterClass);  // [Public] RVA: 0x7C620A8
};
...
public:
    ...
    // --- Functions ---
    bool WasInputKeyJustReleased(Key Key);                                                     // [Final|Public] RVA: 0x7C6B6E8
    bool WasInputKeyJustPressed(Key Key);                                                      // [Final|Public] RVA: 0x7C6B5A4
    void ToggleSpeaking(bool bInSpeaking);                                                     // [Public] RVA: 0x7C6B504
    void TestServerLevelVisibilityChange(const FName PackageName, const FName Filename);       // [Final|Private] RVA: 0x6884DC4
    void SwitchLevel(FString URL);                                                             // [Public] RVA: 0x7C6B430
    void StopHapticEffect(enum Hand);                                                          // [Final|Public] RVA: 0x7C6B37C
    void StartFire(uint8 FireModeNum);                                                         // [Public] RVA: 0x7C6A814
    void SetVirtualJoystickVisibility(bool bVisible);                                          // [Public] RVA: 0x7C6A188
    void SetViewTargetWithBlend(Actor* NewViewTarget, float BlendTime, uint8 BlendFunc, float BlendExp, bool bLockOutgoing);  // [Public] RVA: 0x7C69FA4
    void SetName(FString S);                                                                   // [Public] RVA: 0x7C69EA4
    void SetMouseLocation(const int32 X, const int32 Y);                                       // [Final|Public] RVA: 0x7C69DBC
    void SetMouseCursorWidget(uint8 Cursor, UserWidget* CursorWidget);                         // [Final|Public] RVA: 0x7C69BD8
    void SetHapticsByValue(const float Frequency, const float Amplitude, enum Hand);           // [Final|Public] RVA: 0x7C6994C
    void SetDisableHaptics(bool bNewDisabled);                                                 // [Public] RVA: 0x5E404C4
    void SetControllerLightColor(Color Color);                                                 // [Final|Public] RVA: 0x7C69870
    void SetCinematicMode(bool bInCinematicMode, bool bHidePlayer, bool bAffectsHUD, bool bAffectsMovement, bool bAffectsTurning);  // [Public] RVA: 0x7C69664
    void SetAudioListenerOverride(SceneComponent* AttachToComponent, Vector Location, Rotator Rotation);  // [Final|Public] RVA: 0x7C69464
    void SetAudioListenerAttenuationOverride(SceneComponent* AttachToComponent, Vector AttenuationLocationOVerride);  // [Final|Public] RVA: 0x7C692DC
    void ServerViewSelf(ViewTargetTransitionParams TransitionParams);                          // [Public] RVA: 0x7C69200
    void ServerViewPrevPlayer();                                                               // [Public] RVA: 0x7C691B4
    void ServerViewNextPlayer();                                                               // [Public] RVA: 0x7C69168
    void ServerVerifyViewTarget();                                                             // [Public] RVA: 0x7C6911C
    void ServerUpdateMultipleLevelsVisibility(const TArray<UpdateLevelVisibilityLevelInfo> LevelVisibilities);  // [Final|Public] RVA: 0x7C69020
    void ServerUpdateLevelVisibility(const UpdateLevelVisibilityLevelInfo LevelVisibility);    // [Final|Public] RVA: 0x14E2228
    void ServerUpdateCamera(Vector_NetQuantize CamLoc, int32 CamPitchAndYaw);                  // [Public] RVA: 0x7C68EE8
    void ServerUnmutePlayer(UniqueNetIdRepl PlayerId);                                         // [Public] RVA: 0x7C68DE8
    void ServerToggleAILogging();                                                              // [Public] RVA: 0x7C68D9C
    void ServerShortTimeout();                                                                 // [Public] RVA: 0x251EE78
    void ServerSetSpectatorWaiting(bool bWaiting);                                             // [Public] RVA: 0x7C68CD4
    void ServerSetSpectatorLocation(Vector NewLoc, Rotator NewRot);                            // [Public] RVA: 0x7C68B7C
    void ServerRestartPlayer();                                                                // [Public] RVA: 0x7C68B30
    void ServerPause();                                                                        // [Public] RVA: 0x7C68AE4
    void ServerNotifyLoadedWorld(FName WorldPackageName);                                      // [Final|Public] RVA: 0x7C68A10
    void ServerMutePlayer(UniqueNetIdRepl PlayerId);                                           // [Public] RVA: 0x7C68910
    void ServerExecRPC(FString Msg);                                                           // [Public] RVA: 0x7C68818
    void ServerExec(FString Msg);                                                              // [Final|Public] RVA: 0x512E9D0
    void ServerCheckClientPossessionReliable();                                                // [Public] RVA: 0x7C687CC
    void ServerCheckClientPossession();                                                        // [Public] RVA: 0x7C68780
    void ServerChangeName(FString S);                                                          // [Public] RVA: 0x7C6865C
    void ServerCamera(FName NewMode);                                                          // [Public] RVA: 0x7C685A0
    void ServerAcknowledgePossession(Pawn* P);                                                 // [Public] RVA: 0x1AF4C7C
    void SendToConsole(FString Command);                                                       // [Public] RVA: 0x7C684CC
    void RestartLevel();                                                                       // [Public] RVA: 0x7C684B4
    void ResetControllerLightColor();                                                          // [Final|Public] RVA: 0x7C68458
    bool ProjectWorldLocationToScreen(Vector WorldLocation, out Vector2D ScreenLocation, bool bPlayerViewportRelative);  // [Final|Public] RVA: 0x7C68220
    void PlayHapticEffect(HapticFeedbackEffect_Base* HapticEffect, enum Hand, float Scale, bool bLoop);  // [Final|Public] RVA: 0x7C67C3C
    void PlayDynamicForceFeedback(float Intensity, float Duration, bool bAffectsLeftLarge, bool bAffectsLeftSmall, bool bAffectsRightLarge, bool bAffectsRightSmall, uint8 Action, LatentActionInfo LatentInfo);  // [Final|Private] RVA: 0x7C67910
    void Pause();                                                                              // [Public] RVA: 0x7C6732C
    void OnServerStartedVisualLogger(bool bIsLogging);                                         // [Public] RVA: 0x7C6728C
    void LocalTravel(FString URL);                                                             // [Public] RVA: 0x7C6718C
    void K2_ClientPlayForceFeedback(ForceFeedbackEffect* ForceFeedbackEffect, FName Tag, bool bLooping, bool bIgnoreTimeDilation, bool bPlayWhilePaused);  // [Final|Public] RVA: 0x7C66F70
    bool IsInputKeyDown(Key Key);                                                              // [Final|Public] RVA: 0x7C66E2C
    void GetViewportSize(out int32 SizeX, out int32 SizeY);                                    // [Final|Public] RVA: 0x7C66D2C
    SpectatorPawn* GetSpectatorPawn();                                                         // [Final|Public] RVA: 0x7C66D14
    bool GetMousePosition(out float LocationX, out float LocationY);                           // [Final|Public] RVA: 0x7C66BE8
    Vector GetInputVectorKeyState(Key Key);                                                    // [Final|Public] RVA: 0x7C66ADC
    void GetInputTouchState(uint8 FingerIndex, out float LocationX, out float LocationY, out bool bIsCurrentlyPressed);  // [Final|Public] RVA: 0x7C66920
    void GetInputMouseDelta(out float DeltaX, out float DeltaY);                               // [Final|Public] RVA: 0x7C6681C
    void GetInputMotionState(out Vector Tilt, out Vector RotationRate, out Vector Gravity, out Vector Acceleration);  // [Final|Public] RVA: 0x7C665A8
    float GetInputKeyTimeDown(Key Key);                                                        // [Final|Public] RVA: 0x7C6645C
    void GetInputAnalogStickState(uint8 WhichStick, out float StickX, out float StickY);       // [Final|Public] RVA: 0x7C66310
    float GetInputAnalogKeyState(Key Key);                                                     // [Final|Public] RVA: 0x7C661C4
    HUD* GetHUD();                                                                             // [Final|Public] RVA: 0x7C657B4
    bool GetHitResultUnderFingerForObjects(uint8 FingerIndex, const TArray<uint8> ObjectTypes, bool bTraceComplex, out HitResult HitResult);  // [Final|Public] RVA: 0x7C65FD8
    bool GetHitResultUnderFingerByChannel(uint8 FingerIndex, uint8 TraceChannel, bool bTraceComplex, out HitResult HitResult);  // [Final|Public] RVA: 0x7C65E18
    bool GetHitResultUnderFinger(uint8 FingerIndex, uint8 TraceChannel, bool bTraceComplex, out HitResult HitResult);  // [Final|Public] RVA: 0x7C65C58
    bool GetHitResultUnderCursorForObjects(const TArray<uint8> ObjectTypes, bool bTraceComplex, out HitResult HitResult);  // [Final|Public] RVA: 0x7C65ABC
    bool GetHitResultUnderCursorByChannel(uint8 TraceChannel, bool bTraceComplex, out HitResult HitResult);  // [Final|Public] RVA: 0x7C65944
    bool GetHitResultUnderCursor(uint8 TraceChannel, bool bTraceComplex, out HitResult HitResult);  // [Final|Public] RVA: 0x7C657CC
    Vector GetFocalLocation();                                                                 // [Public] RVA: 0x7C6577C
    float GetDeprecatedInputYawScale();                                                        // [Final|Public] RVA: 0x4FAAEB8
    float GetDeprecatedInputRollScale();                                                       // [Final|Public] RVA: 0x7C65764
    float GetDeprecatedInputPitchScale();                                                      // [Final|Public] RVA: 0x50A2C44
    void FOV(float NewFOV);                                                                    // [Public] RVA: 0x7C655A4
    void EnableCheats();                                                                       // [Public] RVA: 0x7C6558C
    bool DoLineTraceAtScreenPosition(const Vector2D ScreenPosition, const uint8 TraceChannel, bool bTraceComplex, out HitResult HitResult);  // [Final|Public] RVA: 0x7C653D0
    bool DeprojectScreenPositionToWorld(float ScreenX, float ScreenY, out Vector WorldLocation, out Vector WorldDirection);  // [Final|Public] RVA: 0x7C651C4
    bool DeprojectMousePositionToWorld(out Vector WorldLocation, out Vector WorldDirection);   // [Final|Public] RVA: 0x7C65050
    void ConsoleKey(Key Key);                                                                  // [Public] RVA: 0x7C64F60
    void ClientWasKicked(const FText KickReason);                                              // [Public] RVA: 0x7C64EA0
    void ClientVoiceHandshakeComplete();                                                       // [Public] RVA: 0x27A5F10
    void ClientUpdateMultipleLevelsStreamingStatus(const TArray<UpdateLevelStreamingLevelStatus> LevelStatuses);  // [Public] RVA: 0x7C64DA0
    void ClientUpdateLevelStreamingStatus(FName PackageName, bool bNewShouldBeLoaded, bool bNewShouldBeVisible, bool bNewShouldBlockOnLoad, int32 LODIndex);  // [Public] RVA: 0x7C64B98
    void ClientUnmutePlayer(UniqueNetIdRepl PlayerId);                                         // [Public] RVA: 0x7C64AC8
    void ClientTravelInternal(FString URL, uint8 TravelType, bool bSeamless, Guid MapPackageGuid);  // [Public] RVA: 0x7C648D8
    void ClientTravel(FString URL, uint8 TravelType, bool bSeamless, Guid MapPackageGuid);     // [Final|Public] RVA: 0x7C64724
    void ClientTeamMessage(PlayerState* SenderPlayerState, FString S, FName Type, float MsgLifeTime);  // [Public] RVA: 0x7C6458C
    void ClientStopForceFeedback(ForceFeedbackEffect* ForceFeedbackEffect, FName Tag);         // [Public] RVA: 0x7C644A0
    void ClientStopCameraShakesFromSource(CameraShakeSourceComponent* SourceComponent, bool bImmediately);  // [Final|Public] RVA: 0x7C643A0
    void ClientStopCameraShake(TSubclassOf<CameraShakeBase> Shake, bool bImmediately);         // [Public] RVA: 0x7C642B0
    void ClientStopCameraAnim(CameraAnim* AnimToStop);                                         // [Public] RVA: 0x7C64210
    void ClientStartOnlineSession();                                                           // [Public] RVA: 0x7C641F8
    void ClientStartCameraShakeFromSource(TSubclassOf<CameraShakeBase> Shake, CameraShakeSourceComponent* SourceComponent);  // [Final|Public] RVA: 0x7C640CC
    void ClientStartCameraShake(TSubclassOf<CameraShakeBase> Shake, float Scale, enum PlaySpace, Rotator UserPlaySpaceRot);  // [Public] RVA: 0x7C63F34
    void ClientSpawnCameraLensEffect(TSubclassOf<EmitterCameraLensEffectBase> LensEffectEmitterClass);  // [Public] RVA: 0x49ABE30
    void ClientSetViewTarget(Actor* A, ViewTargetTransitionParams TransitionParams);           // [Public] RVA: 0x7C63E20
    void ClientSetSpectatorWaiting(bool bWaiting);                                             // [Public] RVA: 0x7C63D80
    void ClientSetHUD(TSubclassOf<HUD> NewHUDClass);                                           // [Public] RVA: 0x2235EC8
    void ClientSetForceMipLevelsToBeResident(MaterialInterface* Material, float ForceDuration, int32 CinematicTextureGroups);  // [Public] RVA: 0x7C63C4C
    void ClientSetCinematicMode(bool bInCinematicMode, bool bAffectsMovement, bool bAffectsTurning, bool bAffectsHUD);  // [Public] RVA: 0x7C63A98
    void ClientSetCameraMode(FName NewCamMode);                                                // [Public] RVA: 0x7C639FC
    void ClientSetCameraFade(bool bEnableFading, Color FadeColor, Vector2D FadeAlpha, float FadeTime, bool bFadeAudio, bool bHoldWhenFinished);  // [Public] RVA: 0x7C637BC
    void ClientSetBlockOnAsyncLoading();                                                       // [Public] RVA: 0x5E4259C
    void ClientReturnToMainMenuWithTextReason(const FText ReturnReason);                       // [Public] RVA: 0x7C636FC
    void ClientReturnToMainMenu(FString ReturnReason);                                         // [Public] RVA: 0x7C635FC
    void ClientRetryClientRestart(Pawn* NewPawn);                                              // [Public] RVA: 0x7C6355C
    void ClientRestart(Pawn* NewPawn);                                                         // [Public] RVA: 0xFA0634
    void ClientReset();                                                                        // [Public] RVA: 0x7C5AE08
    void ClientRepObjRef(Object* Object);                                                      // [Public] RVA: 0x7C634BC
    void ClientReceiveLocalizedMessage(TSubclassOf<LocalMessage> Message, int32 Switch, PlayerState* RelatedPlayerState_1, PlayerState* RelatedPlayerState_2, Object* OptionalObject);  // [Public] RVA: 0x19AA86C
    void ClientPrestreamTextures(Actor* ForcedActor, float ForceDuration, bool bEnableStreaming, int32 CinematicTextureGroups);  // [Public] RVA: 0x7C63320
    void ClientPrepareMapChange(FName LevelName, bool bFirst, bool bLast);                     // [Public] RVA: 0x7C631D8
    void ClientPlaySoundAtLocation(SoundBase* Sound, Vector Location, float VolumeMultiplier, float PitchMultiplier);  // [Public] RVA: 0x7C63040
    void ClientPlaySound(SoundBase* Sound, float VolumeMultiplier, float PitchMultiplier);     // [Public] RVA: 0x7C62F0C
    void ClientPlayForceFeedback_Internal(ForceFeedbackEffect* ForceFeedbackEffect, ForceFeedbackParameters Params);  // [Final|Private] RVA: 0x7C62E04
    void ClientPlayCameraAnim(CameraAnim* AnimToPlay, float Scale, float Rate, float BlendInTime, float BlendOutTime, bool bLoop, bool bRandomStartTime, enum Space, Rotator CustomPlaySpace);  // [Public] RVA: 0x7C62AAC
    void ClientMutePlayer(UniqueNetIdRepl PlayerId);                                           // [Public] RVA: 0x7C629DC
    void ClientMessage(FString S, FName Type, float MsgLifeTime);                              // [Public] RVA: 0x7C6288C
    void ClientIgnoreMoveInput(bool bIgnore);                                                  // [Public] RVA: 0x7C627EC
    void ClientIgnoreLookInput(bool bIgnore);                                                  // [Public] RVA: 0x5CC4F44
    void ClientGotoState(FName NewState);                                                      // [Public] RVA: 0x231EA68
    void ClientGameEnded(Actor* EndGameFocus, bool bIsWinner);                                 // [Public] RVA: 0x7C626FC
    void ClientForceGarbageCollection();                                                       // [Public] RVA: 0x5CC51B4
    void ClientFlushLevelStreaming();                                                          // [Final|Public] RVA: 0x7C62684
    void ClientEndOnlineSession();                                                             // [Public] RVA: 0x7C6266C
    void ClientEnableNetworkVoice(bool bEnable);                                               // [Public] RVA: 0x15390A4
    void ClientCommitMapChange();                                                              // [Public] RVA: 0x5CC51CC
    void ClientClearCameraLensEffects();                                                       // [Public] RVA: 0x7C62654
    void ClientCapBandwidth(int32 Cap);                                                        // [Public] RVA: 0x2306988
    void ClientCancelPendingMapChange();                                                       // [Public] RVA: 0x7C6263C
    void ClientAddTextureStreamingLoc(Vector InLoc, float Duration, bool bOverrideLocation);   // [Final|Public] RVA: 0x7C62504
    void ClearAudioListenerOverride();                                                         // [Final|Public] RVA: 0x7C624D8
    void ClearAudioListenerAttenuationOverride();                                              // [Final|Public] RVA: 0x7C624AC
    bool CanRestartPlayer();                                                                   // [Public] RVA: 0x7C62484
    void Camera(FName NewMode);                                                                // [Public] RVA: 0x7C623E8
    void AddYawInput(float Val);                                                               // [Public] RVA: 0x7C62348
    void AddRollInput(float Val);                                                              // [Public] RVA: 0x7C622A8
    void AddPitchInput(float Val);                                                             // [Public] RVA: 0x7C62208
    void ActivateTouchInterface(TouchInterface* NewTouchInterface);                            // [Public] RVA: 0x7C62008
};
...
public:
    ...
    // --- Functions ---
    void ReceiveOverrideWith(PlayerState* OldPlayerState);                                     // [Protected] RVA: 0x182D96C
    void ReceiveCopyProperties(PlayerState* NewPlayerState);                                   // [Protected] RVA: 0x182D96C
    void OnRep_UniqueId();                                                                     // [Public] RVA: 0x469B4CC
    void OnRep_Score();                                                                        // [Public] RVA: 0x1C0B120
    void OnRep_PlayerName();                                                                   // [Public] RVA: 0x1EF4B40
    void OnRep_PlayerId();                                                                     // [Public] RVA: 0x231BF30
    void OnRep_bIsInactive();                                                                  // [Public] RVA: 0x469295C
    FString GetPlayerName();                                                                   // [Final|Public] RVA: 0x18512F4
    uint8 GetCompressedPingStdDev();                                                           // [Final|Public] RVA: 0x29AE1C8
    uint8 GetCompressedPingForTwoSeconds();                                                    // [Final|Public] RVA: 0x29AE4F0
    uint8 GetCompressedPingForHalfSecond();                                                    // [Final|Public] RVA: 0x29AE508
    uint8 GetCompressedPing();                                                                 // [Final|Public] RVA: 0x1D8BB1C
};
...
public:
    ...
    // --- Functions ---
    WorldSettings* K2_GetWorldSettings();                                                      // [Final|Public] RVA: 0x7C9B454
    bool HasValidSceneEV100();                                                                 // [Final|Public] RVA: 0x7C9B430
    void HandleTimelineScrubbed();                                                             // [Final|Public] RVA: 0x7C9B41C
    float GetLastSmoothedSceneEV100();                                                         // [Final|Public] RVA: 0x5E60798
    float GetLastSceneEV100();                                                                 // [Final|Public] RVA: 0x7C9B404
};
...
public:
    ...
    // --- Functions ---
    void OnRep_WorldGravityZ();                                                                // [Public] RVA: 0x1C0B120
};
...
public:
    ...
    // --- Functions ---
    void ShowBurnin();                                                                         // [Final|Public] RVA: 0x76BB548
    void SetSequence(LevelSequence* InSequence);                                               // [Final|Public] RVA: 0x76BB4AC
    void SetReplicatePlayback(bool ReplicatePlayback);                                         // [Final|Public] RVA: 0x76BB3F8
    void SetBindingByTag(FName BindingTag, const TArray<Actor*> Actors, bool bAllowBindingsFromAsset);  // [Final|Public] RVA: 0x76BB150
    void SetBinding(MovieSceneObjectBindingID Binding, const TArray<Actor*> Actors, bool bAllowBindingsFromAsset);  // [Final|Public] RVA: 0x76BAFC0
    void ResetBindings();                                                                      // [Final|Public] RVA: 0x76BAFAC
    void ResetBinding(MovieSceneObjectBindingID Binding);                                      // [Final|Public] RVA: 0x76BAEE8
    void RemoveBindingByTag(FName Tag, Actor* Actor);                                          // [Final|Public] RVA: 0x76BAE00
    void RemoveBinding(MovieSceneObjectBindingID Binding, Actor* Actor);                       // [Final|Public] RVA: 0x76BACEC
    void OnLevelSequenceLoaded__DelegateSignature();                                           // [Public] RVA: 0x182D96C
    LevelSequence* LoadSequence();                                                             // [Final|Public] RVA: 0x76BAC54
    void HideBurnin();                                                                         // [Final|Public] RVA: 0x76BAC08
    LevelSequencePlayer* GetSequencePlayer();                                                  // [Final|Public] RVA: 0x76BABB8
    LevelSequence* GetSequence();                                                              // [Final|Public] RVA: 0x76BAB64
    TArray<MovieSceneObjectBindingID> FindNamedBindings(FName Tag);                            // [Final|Public] RVA: 0x76BA9AC
    MovieSceneObjectBindingID FindNamedBinding(FName Tag);                                     // [Final|Public] RVA: 0x76BA8C0
    void AddBindingByTag(FName BindingTag, Actor* Actor, bool bAllowBindingsFromAsset);        // [Final|Public] RVA: 0x76BA5D4
    void AddBinding(MovieSceneObjectBindingID Binding, Actor* Actor, bool bAllowBindingsFromAsset);  // [Final|Public] RVA: 0x76BA46C
};
...
public:
    ...
    // --- Functions ---
    void GetQuestNodeGraphFromPC(PlayerController* InOwnerPC, out TArray<MFQuestNodeGraph*> InGraphList);  // [Public] RVA: 0x60C835C
    MFQuestNodeGraph* CreateNewQuestGraph(Controller* InOwnerController);                      // [Public] RVA: 0x60C79F0
};
...
public:
    ...
    // --- Functions ---
    void SpawnFromPool(const bool Reconstruct, const PoolSpawnOptions SpawnOptions, const Transform SpawnTransform);  // [Final|Public] RVA: 0x4A2BFC4
    void SetLifeSpanPool(float InLifespan);                                                    // [Public] RVA: 0x4A2BD4C
    void ReturnToPool();                                                                       // [Final|Public] RVA: 0x4A2BD10
    SharedObjectPool* GetSharedPool();                                                         // [Final|Public] RVA: 0x4798CC8
    ObjectPool* GetOwningPool();                                                               // [Final|Public] RVA: 0x4A2B1EC
    float GetLifeSpanPool();                                                                   // [Public] RVA: 0x4A2A5E0
    void EVENT_OnPoolEndPlay();                                                                // [Public] RVA: 0x1C0B120
    void EVENT_OnPoolBeginPlay();                                                              // [Public] RVA: 0x1EF4B40
};
...
public:
    ...
    // --- Functions ---
    void Recalculate();                                                                        // [Final|Public] RVA: 0x5C46684
    void PlaySmokeEffectWithDelay();                                                           // [Final|Public] RVA: 0x5C46670
    void OnDoorStateChange(SGDoorBase* Door, enum NewState);                                   // [Final|Public] RVA: 0x5C45FF4
    void OnActorLeave(Actor* OverlappedActor, Actor* OtherActor);                              // [Final|Private] RVA: 0x13A137C
    void OnActorEnter(Actor* OverlappedActor, Actor* OtherActor);                              // [Final|Private] RVA: 0x13A1864
    bool IsLineTraceHit(const Vector Start, const Vector End);                                 // [Final|Public] RVA: 0x5C45E80
    void InitializeVolume();                                                                   // [Final|Public] RVA: 0x5C45E6C
    bool HasOverlapBox(const Vector Pos, const Quat Rot, const Vector BoxHalfExtent);          // [Final|Public] RVA: 0x5C45BEC
    void DynamicTextureTest(StaticMeshActor* StaticMeshActor);                                 // [Final|Public] RVA: 0x5C44E84
};
...
public:
    ...
    // --- Functions ---
    int32 TotalKillCount();                                                                    // [Final|Public] RVA: 0x5C69CBC
    void SetIsSafeKeeper(bool InValue);                                                        // [Final|Public] RVA: 0x5C699D4
    void SetCanStartAI();                                                                      // [Final|Public] RVA: 0x5C699BC
    void SetAIUID(int64 InValue);                                                              // [Final|Public] RVA: 0x5C6987C
    void SetAIReady(bool bReady, bool bSpawnAtUnderGround);                                    // [Final|Public] RVA: 0x5C69778
    void SetAIName(FString NewName);                                                           // [Final|Public] RVA: 0x5C69614
    void SetAIID(int64 InValue);                                                               // [Final|Public] RVA: 0x5C69570
    void SetAIAvatarUrl(FString NewAvatarUrl);                                                 // [Final|Public] RVA: 0x5C694C8
    void SetAIActive(bool Active);                                                             // [Final|Public] RVA: 0x5C69424
    bool RemoveEQSDataInstance(int32 QueryID);                                                 // [Final|Public] RVA: 0x5C69078
    void OnRep_AIUIDChanged();                                                                 // [Final|Protected] RVA: 0x21209D4
    void OnRep_AIReady();                                                                      // [Final|Protected] RVA: 0x5C68E78
    void OnRep_AIActiveChanged();                                                              // [Final|Protected] RVA: 0x1C8EDE4
    void OnPostDied(Character* DeadCharacter, Controller* Killer, DamageEventObject* DamageEventObject);  // [Final|Public] RVA: 0x5C68D38
    void OnKillOther(const KillInfo KillInfo, const KillOtherStatis KillOtherStatics);         // [Final|Public] RVA: 0x5C68BFC
    void OnHandleAfterCharacterUpdateAvatarLayers();                                           // [Final|Protected] RVA: 0x1DAE668
    bool MarkBattleLeave(enum reason);                                                         // [Final|Public] RVA: 0x5C68B54
    bool MarkBattleEnter();                                                                    // [Final|Public] RVA: 0x5C68B30
    bool IsAIReady();                                                                          // [Final|Public] RVA: 0x5C68AFC
    float GetTimeBecomeSafeKeeper();                                                           // [Final|Public] RVA: 0x5C68A44
    Actor* GetStartSpot();                                                                     // [Final|Public] RVA: 0x5C68A20
    Vector GetSpawnPosition();                                                                 // [Final|Public] RVA: 0x5C689F8
    int64 GetPathGroupID();                                                                    // [Final|Public] RVA: 0x5C689E0
    int64 GetID();                                                                             // [Final|Public] RVA: 0x5C68990
    int64 GetHandle();                                                                         // [Final|Public] RVA: 0x5C6896C
    NPCAICoverEnvQueryData* GetEQSDataInstance(int32 QueryID);                                 // [Final|Public] RVA: 0x5C6879C
    float GetBattleDuration();                                                                 // [Final|Public] RVA: 0x5C68774
    PMCAIProfileInfo GetAIProfileInfo();                                                       // [Final|Public] RVA: 0x5C68758
    int32 GetAILevel();                                                                        // [Final|Public] RVA: 0x5C68740
    float GetAIActivedTime();                                                                  // [Public] RVA: 0x5C68710
    bool GetAIActive();                                                                        // [Public] RVA: 0x5C686E0
    NPCAICoverEnvQueryData* CreateEQSDataInstance(int32 QueryID);                              // [Final|Public] RVA: 0x5C68638
    bool BackToSpawnPoint();                                                                   // [Final|Public] RVA: 0x5C682C8
};
...
public:
    ...
    // --- Functions ---
    void SetRotationInterval(float InRotationInterval);                                        // [Final|Public] RVA: 0x5C6E360
    void SetPauseZombieRotation(enum reason, bool bPause);                                     // [Final|Public] RVA: 0x5C6E274
    void RequestResumeBehaviorTree(enum reason, FString Message);                              // [Final|Public] RVA: 0x5C6DEF4
    void RequestPauseBehaviorTree(enum reason, FString Message);                               // [Final|Public] RVA: 0x5C6DDEC
    void OnPostDied(Character* DeadCharacter, Controller* Killer, DamageEventObject* DamageEventObject);  // [Final|Protected] RVA: 0x5C6D358
    void OnGoalEnmeyChanged(Character* FromCharacter, Actor* LastEnemy, Actor* CurrentEnemy);  // [Final|Protected] RVA: 0x5C6D1EC
    void ModifyRotation_Recoil(float DeltaTime, bool bUpdateControlRotation, const Vector FocalPoint, out Rotator ViewRotation, const Rotator BaseRotation);  // [Final|Protected] RVA: 0x5C6CB90
    bool IsZombieRotationPaused();                                                             // [Final|Public] RVA: 0x5C6CB74
    bool IsTargetLastBeenSeen(Actor* InTarget);                                                // [Public] RVA: 0x5C6C988
    bool IsBehaviorTreePausedByReason(enum reason);                                            // [Final|Public] RVA: 0x5C6C8B0
    bool IsBehaviorTreePaused();                                                               // [Final|Public] RVA: 0x5C6C894
    Actor* GetStartSpot();                                                                     // [Final|Public] RVA: 0x5C6C804
    void ForceResumeAllBehaviorTree(FString Message);                                          // [Final|Public] RVA: 0x5C6BFE4
    bool FindAimPoint(const Vector DoubtPoint, const float CostLimit, bool bStanding, float IgnPointRadius, out Vector OutAimPoint, out bool OutIsPartial);  // [Final|Public] RVA: 0x5C6BD38
};
...
public:
    ...
    // --- Functions ---
    void SetForceGameMesh(bool bInForceGameMesh);                                              // [Final|Protected] RVA: 0x5C90FB8
    void ResetMesh(SceneCaptureComponent2D* InSceneCaptureComponent);                          // [Final|Protected] RVA: 0x5C90D70
    int32 GetForcedLOD();                                                                      // [Final|Protected] RVA: 0x5C909D4
};
...
public:
    ...
    // --- Functions ---
    void PoolEndPlay();                                                                        // [Final|Protected] RVA: 0x1EC8C24
};
...
public:
    ...
    // --- Functions ---
    void UpdateViewPointOffsetForReplay(Vector InOffset);                                      // [Final|Public] RVA: 0x5C9F298
    void UpdateLinkIndicatorTarget(SGCharacter* NewTarget);                                    // [Final|Public] RVA: 0x5C9F1FC
    void UpdateHealthForReplay(float InHealth);                                                // [Final|Public] RVA: 0x5C9F154
    void UpdateHeadLocationForReplay(Vector InHeadLocation);                                   // [Final|Public] RVA: 0x5C9F0A8
    void UpdateDesiredFOVForReplay(bool bZooming);                                             // [Final|Public] RVA: 0x5C9EF6C
    void UpdateCurrentTotalValueForReplay(int32 InCurrentTotalValue);                          // [Final|Public] RVA: 0x5C9EEC8
    void UpdateCharactersBodyBounds(const BoxSphereBounds InBodyBounds);                       // [Final|Public] RVA: 0x5C9EDEC
    void UpdateCameraLocationForReplay(Vector InCameraLocation);                               // [Final|Public] RVA: 0x5C9EC5C
    void SetMeshTickThisFrame(bool InMeshTickThisFrame);                                       // [Final|Public] RVA: 0x5C9E9D8
    void SetLastUpdateMeshRotation(Rotator InLastUpdateMeshRotation);                          // [Public] RVA: 0x5C9E92C
    void SetFactionType(enum NewFactionType);                                                  // [Final|Public] RVA: 0x5C9E228
    void SetDressInventoryFinished(bool bFinished);                                            // [Final|Public] RVA: 0x5C9E180
    void SetDressAvatarInvisible(bool bInvisible);                                             // [Final|Public] RVA: 0x5C9E0D8
    void SetCharacterSex(enum InCharacterSex);                                                 // [Final|Public] RVA: 0x5C9E040
    void SetCharacterLocationReliable(Vector position);                                        // [Public] RVA: 0x5C9DF94
    void ServerSwitchSecurityCamera(int32 IndexDelta);                                         // [Public] RVA: 0x5C9DD9C
    void ServerSetTurnInfo(uint8 InputPlayerTurnInfo);                                         // [Public] RVA: 0x5C9DCE4
    void ServerSetEnterSmokeStatus(bool bEnter);                                               // [Public] RVA: 0x5C9DC44
    void ServerPredictStopLocation(const Vector InPredictStopLocation);                        // [Public] RVA: 0x5C9DB50
    void ServerNotifyInteractParamEvent(Actor* InteractTarget, enum EventType, SGInteractComponentBase* SGInteractComponentBase, const TArray<SGInventory*> SelectInventories);  // [Public] RVA: 0x5C9D978
    void ServerNotifyInteractEvent(Actor* InteractTarget, enum EventType, SGInteractComponentBase* SGInteractComponentBase);  // [Public] RVA: 0x5C9D810
    void ServerCancelViewMonitor();                                                            // [Public] RVA: 0x5C9D7C4
    void ResetDressAvatarCounter();                                                            // [Final|Public] RVA: 0x5C9D7A8
    void RemoveGameplayTagChangedEventByTagName(FDelegate InDelegate, FString TagName, uint8 EventType);  // [Final|Public] RVA: 0x5C9D5E0
    void RemoveGameplayTagChangedEvent(FDelegate InDelegate, const GameplayTag Tag, uint8 EventType);  // [Final|Public] RVA: 0x5C9D488
    void RegisterGameplayTagChangedEventByTagName(FDelegate InDelegate, FString TagName, uint8 EventType);  // [Final|Public] RVA: 0x17214F8
    void RegisterGameplayTagChangedEvent(FDelegate InDelegate, const GameplayTag Tag, uint8 EventType);  // [Final|Public] RVA: 0x5C9D330
    void OnZoomChanged(bool bIsZooming);                                                       // [Final|Public] RVA: 0x5C9D0F0
    void OnTinnitus(GameplayTag Tag, int32 Count);                                             // [Final|Protected] RVA: 0x1FC0270
    void OnSwitchWeaponCompleted(SGWeapon* Weapon, FString WeaponName, SGWeapon* OldWeapon);   // [Final|Protected] RVA: 0x5C9CF98
    void OnSwitchWeapon(SGWeapon* Weapon, FString WeaponName);                                 // [Final|Protected] RVA: 0x5C9CE90
    void OnStopSpectatedInvoke(PlayerController* PC);                                          // [Final|Public] RVA: 0x5C9CE00
    void OnStartSpectatedInvoke(PlayerController* PC);                                         // [Final|Public] RVA: 0x27AAC38
    void OnSetNewOwnerInvoke(Actor* NewOwner);                                                 // [Final|Public] RVA: 0x5C9CD5C
    void OnRep_TickingOnDeath();                                                               // [Final|Protected] RVA: 0x1E39618
    void OnRep_ReplicateionVaultInfo();                                                        // [Final|Protected] RVA: 0x15ECFC0
    void OnRep_ReadyToPlay();                                                                  // [Final|Protected] RVA: 0x1643F64
    void OnRep_ProxyCounter();                                                                 // [Final|Private] RVA: 0x5C9CD48
    void OnRep_PlayerViewInfo();                                                               // [Public] RVA: 0x1193BD8
    void OnRep_GID();                                                                          // [Final|Protected] RVA: 0xEB00E0
    void OnRep_FastRepProxy();                                                                 // [Final|Protected] RVA: 0x5C9CD34
    void OnRep_EnterSmoke();                                                                   // [Final|Protected] RVA: 0x226D9C8
    void OnRep_CharacterSex();                                                                 // [Public] RVA: 0x1D9DA3C
    void OnRep_CharacterProxy();                                                               // [Final|Public] RVA: 0x1E39618
    void OnRep_CharacterFactionType();                                                         // [Protected] RVA: 0x21430E8
    void OnRefreshVisibilityBasedAnimTickOption(bool bActiveLongDistanceTacticalInv);          // [Final|Public] RVA: 0x5C9CCA0
    void OnPeriodicGameplayEffectExecute(AbilitySystemComponent* AbilitySystemComp, const GameplayEffectSpec GameplayEffectSpec, ActiveGameplayEffectHandle ActiveGameplayEffectHandle);  // [Final|Public] RVA: 0x5C9CB0C
    void OnGameplayEffectApplied(AbilitySystemComponent* AbilitySystemComp, const GameplayEffectSpec GameplayEffectSpec, ActiveGameplayEffectHandle ActiveGameplayEffectHandle);  // [Final|Public] RVA: 0x5C9C978
    void OnGameModePlayerFinishGame(PlayerController* PlayerController, enum FinishType, Actor* EscapeVolume);  // [Final|Public] RVA: 0x5C9C838
    void OnFullBodyGestureTagChanged(GameplayTag Tag, int32 Count);                            // [Final|Protected] RVA: 0x5C9C750
    void OnCharacterEnableHighPowerScope(bool bAssembled);                                     // [Final|Public] RVA: 0x1DB6BDC
    void OnBeginGame(PlayerController* PC);                                                    // [Final|Public] RVA: 0x5C9C6B4
    void OnAnyGameplayEffectRemoved(const ActiveGameplayEffect ActiveGameplayEffect);          // [Final|Public] RVA: 0x5C9C21C
    void NotifyInteractParamEvent(Actor* InteractTarget, enum EventType, SGInteractComponentBase* SGInteractComponentBase, const TArray<SGInventory*> SelectInventories);  // [Public] RVA: 0x5C9C07C
    void NotifyInteractEvent(Actor* InteractTarget, enum EventType, SGInteractComponentBase* SGInteractComponentBase);  // [Public] RVA: 0x5C9BF48
    void NetMulticastUpdateReplicationInfo(const ReplicationInfo Info);                        // [Public] RVA: 0x5C9BE94
    void MulticastSetCharacterLocation(Vector position);                                       // [Public] RVA: 0x5C9BDE8
    void MulticastHelpMe();                                                                    // [Public] RVA: 0x5C9BDD0
    void K2_OnStartProne(float HalfHeightAdjust, float ScaledHalfHeightAdjust);                // [Public] RVA: 0x182D96C
    void K2_OnStartDive(float HalfHeightAdjust, float ScaledHalfHeightAdjust);                 // [Public] RVA: 0x182D96C
    void K2_OnStartDBNO(float HalfHeightAdjust, float ScaledHalfHeightAdjust);                 // [Public] RVA: 0x182D96C
    void K2_OnEndProne(float HalfHeightAdjust, float ScaledHalfHeightAdjust);                  // [Public] RVA: 0x182D96C
    void K2_OnEndDive(float HalfHeightAdjust, float ScaledHalfHeightAdjust);                   // [Public] RVA: 0x182D96C
    void K2_OnEndDBNO(float HalfHeightAdjust, float ScaledHalfHeightAdjust);                   // [Public] RVA: 0x182D96C
    bool IsUsingHDMesh();                                                                      // [Final|Public] RVA: 0x5C9BDB8
    bool IsReadyToPlay();                                                                      // [Final|Public] RVA: 0x5C9BDA0
    bool IsLocalCapture();                                                                     // [Final|Public] RVA: 0x5C9BD88
    bool IsDressInventoryFinished();                                                           // [Final|Public] RVA: 0x5C9BD64
    bool IsDressAvatarInvisible();                                                             // [Final|Public] RVA: 0x5C9BD40
    bool IsDressAvatarFinished();                                                              // [Final|Public] RVA: 0x5C9BD20
    bool IsDead();                                                                             // [Final|Public] RVA: 0x5C9BCFC
    bool IsContinuousWeaponChange();                                                           // [Final|Public] RVA: 0x5C9BCE4
    bool IsBlendCameraBoneWhenEnableDualFov();                                                 // [Final|Public] RVA: 0x5C9BBDC
    SGCharacterWeightComponent* GetWeightComponent();                                          // [Final|Public] RVA: 0x5C9BBB8
    SGCharacterWeaponTraceComponent* GetWeaponTraceComponent();                                // [Final|Public] RVA: 0x5C9BB94
    SGCharacterWeaponSwayComponent* GetWeaponSwayComponent();                                  // [Final|Public] RVA: 0x5C9BB70
    SGCharacterWeaponManagerComponent* GetWeaponManagerComponent();                            // [Final|Public] RVA: 0x5C9BB4C
    float GetWantToMoveDirAngle();                                                             // [Final|Public] RVA: 0x5C9BB24
    SGActorUseComponent* GetUseComponent();                                                    // [Final|Public] RVA: 0x5C9BB00
    SGCharacterTeamRescueComponent* GetTeamRescueComponent();                                  // [Final|Public] RVA: 0x5C9BADC
    SGCharacterTakeHitEffectComponent* GetTakeHitEffectComponent();                            // [Final|Public] RVA: 0x5C9BAB8
    SGCharacterTakeCoverComponent* GetTakeCoverComponent();                                    // [Final|Public] RVA: 0x5C9BA94
    SGCharacterStunGrenadeEffectComponent* GetStunGrenadeEffectComponent();                    // [Final|Public] RVA: 0x5C9BA70
    SGInventory* GetSteadyCurrentWeapon();                                                     // [Public] RVA: 0x5C9BA48
    SGCharacterSprintComponent* GetSprintComponent();                                          // [Final|Public] RVA: 0x5C9BA24
    SGAbilitySystemComponent* GetSGAbilitySystemComponent();                                   // [Final|Public] RVA: 0x5C9B988
    SGCharacterSenseAbilityComponent* GetSenseAbilityComponent();                              // [Final|Public] RVA: 0x5C9B9DC
    SGCharacterRagdollNewComponent* GetRagdollComponent();                                     // [Final|Public] RVA: 0x5C9B964
    Rotator GetPronePlaneRot();                                                                // [Public] RVA: 0x5C9B92C
    SGCharacterPreviewComponent* GetPreviewComponent();                                        // [Final|Public] RVA: 0x5C9B908
    SGUAMCharacterPoseCacheComponent* GetPoseCacheComponent();                                 // [Final|Public] RVA: 0x5C9B8E4
    Rotator GetPlayerViewRotation();                                                           // [Public] RVA: 0x5C9B8AC
    PlayerCameraManager* GetPlayerCameraManager();                                             // [Public] RVA: 0x5C9B884
    SGCharacterMovementVaultComponent* GetMovementVaultComponent();                            // [Final|Public] RVA: 0x5C9B6E0
    SGCharacterMovementProneComponent* GetMovementProneComponent();                            // [Final|Public] RVA: 0x5C9B6BC
    SGCharacterMovementLadderClimbComponent* GetMovementLadderClimbComponent();                // [Final|Public] RVA: 0x5C9B698
    SGCharacterMovementDBNOComponent* GetMovementDBNOComponent();                              // [Final|Public] RVA: 0x5C9B674
    SGCharacterMovementAbilityComponent* GetMovementAbilityComponent();                        // [Final|Public] RVA: 0x5C9B650
    SGMotionWarpingComponent* GetMotionWarpingComponent();                                     // [Final|Public] RVA: 0x5C9B62C
    bool GetMeshTickThisFrame();                                                               // [Final|Public] RVA: 0x5C9B614
    float GetLeaveSmokeTime();                                                                 // [Final|Public] RVA: 0x5C9B5FC
    SGCharacterLeanWallComponent* GetLeanComponent();                                          // [Final|Public] RVA: 0x5C9B5D8
    Rotator GetLastUpdateMeshRotation();                                                       // [Public] RVA: 0x5C9B5A0
    Controller* GetLastPossessedController();                                                  // [Final|Public] RVA: 0x5C9B588
    bool GetIsEnterTearGas();                                                                  // [Final|Public] RVA: 0x5C9B570
    SGCharacterInteractionComponent* GetInteractionComponent();                                // [Final|Public] RVA: 0x5C9B54C
    SGCharacterInputProcessComponent* GetInputProcessComponent();                              // [Final|Public] RVA: 0x5C9B528
    SGCharacterIKComponent* GetIKComponent();                                                  // [Final|Public] RVA: 0x5C9B504
    enum GetFactionType();                                                                     // [Final|Public] RVA: 0x5C9B4C4
    float GetEnterSmokeTime();                                                                 // [Final|Public] RVA: 0x5C9B4AC
    SGCharacterEnergyComponent* GetEnergyComponent();                                          // [Final|Public] RVA: 0x5C9B488
    int32 GetDressAvatarFinished();                                                            // [Final|Public] RVA: 0x5C9B468
    SGCharacterDeathComponent* GetDeathComponent();                                            // [Final|Public] RVA: 0x5C9B444
    SGCharacterDBNOComponent* GetDBNOComponent();                                              // [Final|Public] RVA: 0x5C9B420
    SGCharacterCurveBreathComponent* GetCurveBreathComponent();                                // [Final|Public] RVA: 0x5C9B3FC
    SGCharacterWeaponAttachComponent* GetCharacterWeaponAttachComponent();                     // [Final|Public] RVA: 0x5C9B3D8
    SGCharacterVehicleComponent* GetCharacterVehicleComponent();                               // [Final|Public] RVA: 0x5C9B3B4
    SGCharacterTLogComponent* GetCharacterTLogComponent();                                     // [Final|Public] RVA: 0x5C9B348
    SGCharacterTakeDamageComponent* GetCharacterTakeDamageComponent();                         // [Final|Public] RVA: 0x5C9B390
    SGCharacterTacticalPistolComponent* GetCharacterTacticalPistolComponent();                 // [Final|Public] RVA: 0x5C9B36C
    SGCharacterSwimComponent* GetCharacterSwimComponent();                                     // [Final|Public] RVA: 0x5C9B324
    SGCharacterSoundComponent* GetCharacterSoundComponent();                                   // [Final|Public] RVA: 0x5C9B300
    enum GetCharacterSex();                                                                    // [Final|Public] RVA: 0x5C9B2E8
    SGCharacterPerkManagerComponent* GetCharacterPerkManagerComponent();                       // [Final|Public] RVA: 0x5C9B2C4
    SGCharacterMoveBlockedAvoidanceComponent* GetCharacterMoveBlockedAvoidanceComponent();     // [Final|Public] RVA: 0x5C9B2A0
    SGCharacterMeshComponent* GetCharacterMeshComponent();                                     // [Final|Public] RVA: 0x5C9B27C
    SGCharacterLookAroundComponent* GetCharacterLookAroundComponent();                         // [Final|Public] RVA: 0x5C9B258
    SGCharacterLoadProtectComponent* GetCharacterLoadProtectComponent();                       // [Final|Public] RVA: 0x5C9B234
    SGCharacterLagCompensationComponent* GetCharacterLagCompensationComp();                    // [Final|Public] RVA: 0x5C9B210
    SGCharacterInventoryManagerComponent* GetCharacterInventoryManagerComponent();             // [Final|Public] RVA: 0x5C9B1EC
    SGCharacterInventoryGiveComponent* GetCharacterInventoryGiveComponent();                   // [Final|Public] RVA: 0x5C9B1C8
    SGCharacterInventoryComponent* GetCharacterInventoryComponent();                           // [Final|Public] RVA: 0x5C9B1A4
    SGCharacterHealthComponent* GetCharacterHealthComponent();                                 // [Final|Public] RVA: 0x5C9B180
    SGCharacterFragGrenadeEffectComponent* GetCharacterFragGrenadeEffectComponent();           // [Final|Public] RVA: 0x5C9B15C
    SGCharacterFOVComponent* GetCharacterFOVComponent();                                       // [Final|Public] RVA: 0x5C9B114
    SGCharacterFootEffectComponent* GetCharacterFootEffectComponent();                         // [Final|Public] RVA: 0x5C9B138
    SGCharacterEnduranceComponent* GetCharacterEnduranceComponent();                           // [Final|Public] RVA: 0x5C9B0F0
    SGCharacterDeliverCargoComponent* GetCharacterDeliverCargoComponent();                     // [Final|Public] RVA: 0x5C9B0CC
    SGCharacterDebugMovementComponent* GetCharacterDebugMovementComponent();                   // [Final|Public] RVA: 0x5C9B0A8
    SGCharacterBoneBreakComponent* GetCharacterBoneBreakComponent();                           // [Final|Public] RVA: 0x5C9B084
    SGCharacterArmorManagerComponent* GetCharacterArmorManagerComponent();                     // [Final|Public] RVA: 0x5C9B060
    SGCharacterCastShadowComponent* GetCastShadowComponent();                                  // [Final|Public] RVA: 0x5C9B03C
    MFClimateMovableRainWetnessComponent* GetCacheWetnessComponent();                          // [Final|Public] RVA: 0x5C9AF68
    enum GetCachedCharacterType();                                                             // [Final|Public] RVA: 0x5C9AF8C
    SGCharacterAvatarMergeComponent* GetAvatarMergeComponent();                                // [Final|Public] RVA: 0x5C9AF44
    SGCharacterAvatarManagerComponent* GetAvatarManagerComponent();                            // [Final|Public] RVA: 0x5C9AF20
    SGCharacterAvatarComponent* GetAvatarComponent();                                          // [Final|Public] RVA: 0x5C9AEFC
    SGCharacterAIPoseComponent* GetAIPoseComponent();                                          // [Final|Public] RVA: 0x5C9AED8
    SGCharacterAIComponent* GetAIComponent();                                                  // [Final|Public] RVA: 0x5C9AEB4
    void DisableTickOnDeath();                                                                 // [Final|Protected] RVA: 0x5C9AD2C
    void DelayUpdateReplicationInfo();                                                         // [Final|Public] RVA: 0x5C9AD18
    void ClientReceiveForMultiNet();                                                           // [Public] RVA: 0x5C9AC04
    void ClientReceiveDoorUnlockEvent(enum DoorAction, Character* UserActor, SGDoorBase* Door);  // [Public] RVA: 0x5C9AAD0
    void ClientHideCharacter(bool InbHide);                                                    // [Public] RVA: 0x5C9AA30
    void ClientBroadcastAchievement(int32 AchievementID, bool bSubAchievement);                // [Public] RVA: 0x5C9A944
    bool CheckIsInSmoke();                                                                     // [Final|Public] RVA: 0x5C9A890
    void ChangeCameraSpringIntensity(int32 Value);                                             // [Final|Public] RVA: 0x5C9A7EC
    void CacheComponents();                                                                    // [Public] RVA: 0x5C9A7D4
    void CacheCharacterType();                                                                 // [Final|Public] RVA: 0x5C9A7A4
    void BroadcastOnEntersTearGasGrenade(bool bEnter);                                         // [Final|Public] RVA: 0x5C9A708
    void BroadcastOnEntersSmokeGrenade(bool bEnter);                                           // [Final|Public] RVA: 0x5C9A66C
    void AddDressAvatarCounter(bool bAdd, FString Path);                                       // [Final|Public] RVA: 0x5C9A1A0
};
...
public:
    ...
    // --- Functions ---
    Rotator GetViewRotOffset();                                                                // [Public] RVA: 0x5CAE2F0
    SGCharacterBaseTurnComponent* GetTurnComponent();                                          // [Public] RVA: 0x5CAE204
    SGCharacterMovementComponentBase* GetSGCharacterMovement();                                // [Public] RVA: 0x5CAE1DC
    float GetMovingDirAngle();                                                                 // [Public] RVA: 0x5CAE1B0
    Rotator GetMeshRotation();                                                                 // [Final|Public] RVA: 0x5CAE17C
    SGCharacterWeaponManagerComponent* GetCharacterWeaponManagerComponent();                   // [Public] RVA: 0x5CAE0C4
    SGCharacterMovementVaultComponent* GetCharacterVaultComponent();                           // [Public] RVA: 0x5CAE09C
    SGCharacterFallComponent* GetCharacterFallComponent();                                     // [Public] RVA: 0x5CAE074
    SGAnimationComponentBase* GetAnimationComponent();                                         // [Public] RVA: 0x5CAE04C
    float GetAccDirAngle();                                                                    // [Final|Public] RVA: 0x5CAE024
    AbilitySystemComponent* GetAbilitySystemComponent();                                       // [Public] RVA: 0x5CADFF8
    void FreezeEnableWorldOriginRebaseLogic(bool bInFreezeRebaseLogic);                        // [Final|Public] RVA: 0x5CADF5C
    void EnableWorldOriginRebaseLogic(bool bEnable);                                           // [Final|Public] RVA: 0x5CADEC0
};
...
public:
    ...
    // --- Functions ---
    void SwitchEnableCapture(bool bEnable);                                                    // [Final|Public] RVA: 0x5CB14DC
    void SetOwnerCharacter(Pawn* Character);                                                   // [Final|Public] RVA: 0x5CB1574
    void SetCaptureCharacterSwitch(bool bSwitch);                                              // [Final|Public] RVA: 0x5CB14DC
    void ResetRotation();                                                                      // [Final|Public] RVA: 0x5CB14C8
    void OnWeaponEquipPositionChanged(SGInventory* Inventory, enum EquipPosition);             // [Final|Private] RVA: 0x5CB13E0
    void OnShowMergedAvatar(SkeletalMeshComponent* MergedMeshComp, bool bShow);                // [Final|Private] RVA: 0x5CB0E24
    void OnRemoveInventoryEvent(Character* Character, SGInventory* TargetInventory);           // [Final|Private] RVA: 0x5CB0D14
    void OnPlayInventoryAnimation(SGInventory* Inventory, AnimSequenceBase* Anim);             // [Final|Private] RVA: 0x5CB0C2C
    void OnOwnerEquipSkeletalMeshLoadCompleted(SGInventory* Inventory, SkeletalMeshComponent* SkeletalMeshComp);  // [Final|Private] RVA: 0x5CB0B4C
    void OnInventoryAttachPositionChanged(SGInventory* Inventory, const TArray<InventoryContainerBase> OldParentGridBaseTraceList, InventoryContainerBase NewParentContainerBase, enum OldAttachPos, enum NewAttachPos);  // [Final|Private] RVA: 0x5CB0840
    void OnInventoryAnimPoseChanged(SGInventory* Inv, const InventoryAnimPoseInfo AnimPoseInfo);  // [Final|Private] RVA: 0x5CB0738
    void OnFoldStock(SGInventory* StockInventory, bool bFold);                                 // [Final|Private] RVA: 0x5CB05B0
    void OnCharacterSexChanged(enum CharacterSex);                                             // [Final|Private] RVA: 0x5CB0518
    void OnCharacterMeshChanged(SkeletalMesh* CharacterMesh);                                  // [Final|Private] RVA: 0x5CB03C8
    void OnBagOpen();                                                                          // [Final|Private] RVA: 0x5CB03B4
    void OnBagClose();                                                                         // [Final|Private] RVA: 0x5CB03A0
    void OnBadgeAttachPositionChanged(SGInventory* Inv, SGInventory* AttachInv);               // [Final|Private] RVA: 0x5CB02B8
    void OnAvatarRemoved(SGInventory* TargetInventory);                                        // [Final|Private] RVA: 0x5CB0160
    void OnAvatarAdded(SGInventory* TargetInventory);                                          // [Final|Private] RVA: 0x5CAFFCC
    void OnAttachWeaponExtraMesh(SGWeapon* Weapon);                                            // [Final|Private] RVA: 0x5CAFF30
    void OnAfterCharacterUpdateAvatarLayers();                                                 // [Final|Private] RVA: 0x5CAFF1C
    void MergeMesh();                                                                          // [Final|Protected] RVA: 0x5CAFF08
    SGInventoryEquipMeshComponent* GetWearableComponentByID(int64 ItemId);                     // [Final|Public] RVA: 0x5CAF838
    SGInventoryEquipMeshComponent* GetWearableComponent(SGInventory* Inv);                     // [Final|Public] RVA: 0x5CAF45C
    void DeferredCaptureCharacterUpdateLayers();                                               // [Final|Private] RVA: 0x5CAF448
    void CaptureCharacterUpdateMeshLayers();                                                   // [Final|Private] RVA: 0x5CAF420
    void CaptureCharacter(bool bEnableCapture);                                                // [Final|Public] RVA: 0x5CAF384
    void AdjustToBack(SGInventory* Inventory, out MeshComponent* AttachedMeshComponent, out FString AttachedSocke);  // [Final|Protected] RVA: 0x5CAF204
    void AddRotation(Rotator Rotation);                                                        // [Final|Public] RVA: 0x5CAF114
};
...
public:
    ...
    // --- Functions ---
    void SetOpenContainerLootProtectByFaction(bool InOpenContainerLootProtectByFaction);       // [Final|Public] RVA: 0x5D6D568
    void SetFactionType(enum CurFactionType);                                                  // [Public] RVA: 0x5D6D4CC
    bool RemoveFromFaction(SGTeamInfo* Team);                                                  // [Public] RVA: 0x5D6D41C
    void RemoveFactionDomain(SGFactionDomainVolume* Volume);                                   // [Final|Public] RVA: 0x5D6D378
    void RefreshDomainData();                                                                  // [Final|Public] RVA: 0x5D6D364
    void OnRep_FactionmemberBaseInfoArray();                                                   // [Final|Public] RVA: 0x5D6D1DC
    TArray<int32> GetPlayerStartArr();                                                         // [Final|Public] RVA: 0x5D6C7F4
    bool GetOpenContainerLootProtectByFaction();                                               // [Final|Public] RVA: 0x5D6C7DC
    enum GetFactionType();                                                                     // [Final|Public] RVA: 0x5D6C140
    int32 GetFactionMemberCount(out int32 ALiveNum, out int32 TotalNum);                       // [Public] RVA: 0x5D6BD34
    TArray<SGAISpawnPoint*> GetAISpawnPointArr();                                              // [Final|Public] RVA: 0x5D6B008
    bool AddToFaction(SGTeamInfo* Team);                                                       // [Public] RVA: 0x5D6AE14
    void AddFactionDomain(SGFactionDomainVolume* Volume);                                      // [Final|Public] RVA: 0x5D6AD20
};
...
public:
    ...
    // --- Functions ---
    void OnRoundGameStart();                                                                   // [Final|Public] RVA: 0x5D78254
    void OnMissionInformGameEnd(enum GameModeType, bool bRealGameEnd);                         // [Final|Public] RVA: 0x5D77F88
    void OnGameBegin();                                                                        // [Final|Public] RVA: 0x5D77ED8
    bool IsZoneSvrValid();                                                                     // [Final|Public] RVA: 0x5D77DD4
    int32 GetValidPlayerNum();                                                                 // [Public] RVA: 0x5D77D98
    int32 GetTotalPlayerNumber();                                                              // [Final|Public] RVA: 0x5D77D80
    int32 GetTotalAINumber();                                                                  // [Final|Public] RVA: 0x5D77D68
    int32 GetSeedDSMemoryVirtual();                                                            // [Final|Public] RVA: 0x5D77D30
    int32 GetSeedDSMemoryPhysical();                                                           // [Final|Public] RVA: 0x5D77CF8
    int32 GetMaxPlayerNumberSimultaneous();                                                    // [Final|Public] RVA: 0x5D77CE0
    int32 GetMaxFPSExistFrames(int32 InMaxFPSIndex);                                           // [Final|Public] RVA: 0x5D77C38
    int32 GetLuaMemoryAfterFork();                                                             // [Final|Public] RVA: 0x5D77C18
    int32 GetDSMemoryVirtualAfterFork();                                                       // [Final|Public] RVA: 0x5D77BFC
    int32 GetDSMemoryPhysicalAfterFork();                                                      // [Final|Public] RVA: 0x5D77BE0
    void FinishStatOnEndGame();                                                                // [Final|Public] RVA: 0x5D77B38
    PlayerController* FindPlayerControllerByGid(const int64 InGid);                            // [Public] RVA: 0x5D77A88
    void CleanPlayerInfoForReconnection(uint64 InGid);                                         // [Public] RVA: 0x5D77854
    void BroadcastReqPlayerFinishEvent(GameMode* GameMode, PlayerController* Exiting);         // [Final|Public] RVA: 0x5D77488
    void BroadcastReqOBPlayerFinishEvent(GameMode* GameMode, PlayerController* Exiting);       // [Final|Public] RVA: 0x5D773A0
    void BroadcastPlayerStartEvent(PlayerController* Exiting);                                 // [Final|Public] RVA: 0x5D772BC
    void BroadcastPlayerFinishEvent(PlayerController* Exiting, enum ResultType, Actor* EscapeVolume);  // [Final|Public] RVA: 0x5D7717C
};
...
public:
    ...
    // --- Functions ---
    void SetSupportSameCampMode(bool bSupport);                                                // [Final|Public] RVA: 0x5D8B954
    void SetDynamicMissionFlowList(TArray<MissionFlowData> InDynamicMissionFlowList);          // [Final|Public] RVA: 0x5D8B6FC
    void RecordAliveStateByGID(uint64 gid, enum PlayerAliveState);                             // [Final|Public] RVA: 0x5D8B188
    void OnRep_ReplicateServerTime();                                                          // [Public] RVA: 0x1C243B0
    void OnRep_DSNetTickRate();                                                                // [Final|Public] RVA: 0x5D8A71C
    void OnPreBeginGameInit();                                                                 // [Final|Public] RVA: 0x5D8A708
    void OnPlayerFinishGame(PlayerController* PlayerController, enum FinishType, Actor* EscapeVolume);  // [Final|Public] RVA: 0x5D8A554
    void OnLoadCompleted_DebugCompClass(SoftObjectPath Path);                                  // [Final|Protected] RVA: 0x5D8A49C
    void OnEscapeReport(int32 EscapePointID, bool IsGlobal, int32 InReportType, float InExtraData, const TArray<PlayerState*> TriggerPlayerStates, const TArray<PlayerState*> InVolumePlayerStates);  // [Public] RVA: 0x1C6C4B0
    void OnApplicationWillDeactive();                                                          // [Public] RVA: 0x4788980
    void OnApplicationHasReactive();                                                           // [Public] RVA: 0x4788968
    int32 GetSubModeID();                                                                      // [Final|Public] RVA: 0x2830C10
    int32 GetSpecialID();                                                                      // [Final|Public] RVA: 0x5D88BF8
    DateTime GetServerNowTime();                                                               // [Final|Public] RVA: 0x5D88BCC
    enum GetPlayerFinishType(uint64 gid);                                                      // [Final|Public] RVA: 0x5D88B24
    int32 GetPlayerCountByTeamType(enum InTeamType);                                           // [Final|Public] RVA: 0x5D88A7C
    int32 GetMapID();                                                                          // [Final|Public] RVA: 0x252103C
    int32 GetMainModeID();                                                                     // [Final|Public] RVA: 0x2830C34
    enum GetGameSceneType();                                                                   // [Final|Public] RVA: 0x5D8896C
    TArray<MissionFlowData> GetDynamicMissionFlowList();                                       // [Final|Public] RVA: 0x5D88904
    TArray<uint32> GetDistributedMissionFlowIDs();                                             // [Final|Public] RVA: 0x5D887B4
    int32 GetDifficulty();                                                                     // [Final|Public] RVA: 0x25210AC
    enum GetAliveStateByGID(uint64 gid);                                                       // [Final|Public] RVA: 0x5D88294
    void ClientEscapeReport(int32 EscapePointID, bool IsGlobal, int32 InReportType, float InExtraData, const TArray<PlayerController*> TriggerPlayerControllers, const TArray<PlayerController*> InVolumePlayerControllers);  // [Final|Public] RVA: 0x5D87930
    void AddDistributedMissionFlowID(uint32 InMissionFlowID);                                  // [Final|Public] RVA: 0x5D87898
};
...
public:
    ...
    // --- Functions ---
    void ToggleGM();                                                                           // [Protected] RVA: 0x5C60D4C
    void SetAllWidgetVisibility(bool bVisible);                                                // [Final|Public] RVA: 0x5DC2268
    void PreviousDebugCmd();                                                                   // [Protected] RVA: 0x5C60B9C
    void OnShowTextDetail(const FText Text);                                                   // [Final|Private] RVA: 0x5DC1F74
    void OnNewWidgetCreated(SGUserWidget* NewWidget);                                          // [Final|Public] RVA: 0x1CD2CA0
    void OnMoveShowTextDetail(const FText Text, const Vector2D TextDetail);                    // [Final|Private] RVA: 0x5DC1890
    void OnMoveHideTextDetail(const FText Text);                                               // [Final|Private] RVA: 0x5DC17CC
    void OnLoadCompleted_HUDClass(SoftObjectPath Path, int32 CurrentPendingID);                // [Final|Protected] RVA: 0x5DC16C0
    void OnHideTextDetail(const FText Text);                                                   // [Final|Private] RVA: 0x5DC15FC
    void NextDebugCmd();                                                                       // [Protected] RVA: 0x5C60FCC
    void ManualLoadHUDClass();                                                                 // [Final|Public] RVA: 0x5DC15E8
    void InitDebugCmds();                                                                      // [Protected] RVA: 0x29B7FFC
    bool HasSafeZone(Canvas* InCanvas);                                                        // [Final|Protected] RVA: 0x5DC1434
    SGUserWidget* GetUserWidget(TSubclassOf<Object> StaticClass);                              // [Final|Public] RVA: 0x5DC138C
    void EnableSafeZone(Canvas* InCanvas, bool bEnable);                                       // [Final|Protected] RVA: 0x5DC1278
    void EnableHandleEscape(SGUserWidget* Widget, bool bEnable);                               // [Final|Public] RVA: 0x5DC118C
    void DumpHUDDetails();                                                                     // [Final|Protected] RVA: 0x1E39618
    void DrawEllipse(const Vector2D Center, const Vector2D Radius, int32 NumSides, LinearColor LineColor, float LineThickness);  // [Final|Public] RVA: 0x5DC0F40
    void DestroyHUD(out FString ClassName);                                                    // [Final|Protected] RVA: 0x5D70E98
    void DestroyAllManualLoadedHUD();                                                          // [Final|Public] RVA: 0x5DC0F2C
    void DestroyAllComponentClasses();                                                         // [Final|Protected] RVA: 0x1E39618
    void DebugWeapon(int32 DebugFlag);                                                         // [Final|Protected] RVA: 0x4DED0E0
    void DebugSelfMovement(bool bDebugSelfMovement);                                           // [Final|Protected] RVA: 0x4699A84
    void DebugPlayerState(bool bDebugPlayerState);                                             // [Final|Protected] RVA: 0x4699A84
    void DebugLocation();                                                                      // [Final|Protected] RVA: 0x1E39618
    void DebugInput();                                                                         // [Final|Protected] RVA: 0x5DC0EF0
    void DebugDamage(bool bDebugDamage);                                                       // [Final|Protected] RVA: 0x4699A84
    void DebugCamera(bool bDebugCamera);                                                       // [Final|Protected] RVA: 0x4699A84
    void DebugBreath(bool bDebugBreath);                                                       // [Final|Protected] RVA: 0x4699A84
    void DebugAttributeSets_Movement(bool bDebugAttributeSets_Movement);                       // [Final|Protected] RVA: 0x4699A84
    void DebugAppInfo();                                                                       // [Final|Protected] RVA: 0x1E39618
    void DebugAnimationCurve(bool bDebugAnimationCurve);                                       // [Final|Protected] RVA: 0x4699A84
    void DebugAllMovement(bool bDebugAllMovement);                                             // [Final|Protected] RVA: 0x4699A84
    void CreateHUD(out FString ClassName);                                                     // [Final|Protected] RVA: 0x5D70E98
    void ClearDebugCanvas();                                                                   // [Final|Protected] RVA: 0x5DC0EDC
    void CallCreateComponents();                                                               // [Final|Protected] RVA: 0x1E39618
};
...
public:
    ...
    // --- Functions ---
    void PoolEndPlay();                                                                        // [Final|Protected] RVA: 0x1D15B9C
};
...
public:
    ...
    // --- Functions ---
    bool SkipTickOptimize();                                                                   // [Protected] RVA: 0x5DCD23C
    bool ShouldDisplayHitEffect(int32 AttemptedDamage, int32 DamageAmount, int32 FinalHealth, int32 FinalArmor);  // [Public] RVA: 0x5DCD0AC
    void SetWeaponStainSkinID(int64 InWeaponStainSkinID);                                      // [Final|Public] RVA: 0x5DCD010
    void SetShowInvID(bool bShow);                                                             // [Final|Public] RVA: 0x5DCCE90
    void SetRefreshFrameToClient(enum InfoChangeType);                                         // [Public] RVA: 0x5DCCCB4
    void SetRefreshFrame(enum InfoChangeType);                                                 // [Final|Public] RVA: 0x5DCCC1C
    void SetRebornSaftyState(bool IsInRebornSafty);                                            // [Final|Public] RVA: 0x5DCCB80
    void SetIsForbbidenDiscardByCharacter(bool NewSetValue);                                   // [Final|Public] RVA: 0x5DCCA50
    void SetInventoryPaint(bool bUsePaint, int32 TextureId);                                   // [Final|Public] RVA: 0x5DCC958
    void SetFreezed(bool bInFreezed);                                                          // [Final|Public] RVA: 0x5DCC82C
    void SetBindShortcutPos(enum Pos);                                                         // [Final|Public] RVA: 0x5DCC614
    void ReceiveChangeAttachPositionEvent(Character* OwnerCharacter, enum NewPosition);        // [Public] RVA: 0x182D96C
    void ProcessInventoryPaint();                                                              // [Final|Public] RVA: 0x5DCC378
    void OnRep_RuntimeID();                                                                    // [Final|Public] RVA: 0x1D46264
    void OnRep_Repaint();                                                                      // [Final|Public] RVA: 0x5DCC364
    void OnRep_IsInRebornSafty();                                                              // [Final|Public] RVA: 0x5DCC350
    void OnPreGiveTo(Pawn* Target, enum SourceType, enum Pos, ItemGridInfo DropPosition, Actor* InParentActor, SGInventory* Inventory);  // [Final|Protected] RVA: 0x5DCC14C
    void OnInventoryRemoved(Character* OwnerCharacter);                                        // [Final|Protected] RVA: 0x1CE4484
    void OnInventoryAttachPositionChanged(SGInventory* Inventory, Character* OwnerCharacter, enum NewAttachPosition);  // [Protected] RVA: 0x1B8E2DC
    void OnInventoryAdded(Character* OwnerCharacter);                                          // [Final|Protected] RVA: 0x1CE4484
    int64 K2_GetItemID();                                                                      // [Final|Public] RVA: 0x5DCBF00
    bool IsFreezed();                                                                          // [Final|Public] RVA: 0x5DCBEE8
    SGWidgetToRenderTargetComponent* GetWidgetToRenderTargetComponent();                       // [Final|Public] RVA: 0x5DCBB64
    int64 GetWeaponStainSkinID();                                                              // [Final|Public] RVA: 0x5DCBB4C
    uint64 GetRefreshFrameInfoChangeMask(uint64 LastCheckRefreshFrame);                        // [Final|Public] RVA: 0x5DCBA1C
    float GetMoistureCostRatio();                                                              // [Final|Public] RVA: 0x5DCB9F4
    bool GetIsForbbidenDiscardByCharacter();                                                   // [Final|Public] RVA: 0x5DCB968
    FString GetInvName();                                                                      // [Final|Public] RVA: 0x5DCB418
    SGInventoryZoomComponent* GetInventoryZoomComponent();                                     // [Final|Public] RVA: 0x5DCB944
    SGInventoryTypeComponent_Badge* GetInventoryTypeComponent_Badge();                         // [Final|Public] RVA: 0x5DCB920
    SGInventoryTypeComponent_Avatar* GetInventoryTypeComponent_Avatar(bool bForceGet);         // [Final|Public] RVA: 0x5DCB874
    SGInventoryTypeComponent_Armor* GetInventoryTypeComponent_Armor(bool bForceGet);           // [Final|Public] RVA: 0x5DCB7C8
    SGInventorySoundDiffuseComponent* GetInventorySoundDiffuseComponent();                     // [Final|Public] RVA: 0x5DCB7A4
    FString GetInventoryShortName();                                                           // [Final|Public] RVA: 0x11FF878
    FString GetInventoryName();                                                                // [Final|Public] RVA: 0x5DCB6B8
    SGInventoryModifyAttributeComponent* GetInventoryModifyAttributeComp();                    // [Final|Public] RVA: 0x5DCB694
    SGInventoryMeshComponent* GetInventoryMeshComponent();                                     // [Final|Public] RVA: 0x5DCB670
    SGInventoryGridComponent* GetInventoryGridComp();                                          // [Final|Public] RVA: 0x5DCB64C
    SGInventoryEquipMeshComponent* GetInventoryEquipMeshComponent();                           // [Final|Public] RVA: 0x5DCB628
    SGInventoryCommonDataComponent* GetInventoryCommonDataComponent();                         // [Final|Public] RVA: 0x5DCB604
    SGInventoryCameraComponent* GetInventoryCameraComp();                                      // [Final|Public] RVA: 0x5DCB5E0
    SGInventoryAssembleComponent* GetInventoryAssembleComp();                                  // [Final|Public] RVA: 0x5DCB5BC
    SGInventoryAbilityComponent* GetInventoryAbilityComponent();                               // [Final|Public] RVA: 0x5DCB598
    float GetFoodCostRatio();                                                                  // [Final|Public] RVA: 0x5DCB3A0
    Character* GetCharacterOwner();                                                            // [Final|Public] RVA: 0x5DCB2B8
    enum GetBindShortcutPos();                                                                 // [Final|Public] RVA: 0x5DCB2A0
    void DestroySelf();                                                                        // [Final|Public] RVA: 0x5DCB1A0
    void DelayDestroySelf();                                                                   // [Final|Public] RVA: 0x5DCB18C
    void CacheComponents();                                                                    // [Public] RVA: 0x46F6D30
    void BP_SetBagOpenState(Controller* Controller, bool State);                               // [Public] RVA: 0x182D96C
};
...
public:
    ...
    // --- Functions ---
    void UpdatePostProcessComponentWeight(float Weight);                                       // [Public] RVA: 0x182D96C
    void OnDetectInRoomEvent(bool bNotifyInRoom);                                              // [Final|Public] RVA: 0x5E50074
};
...
public:
    ...
    // --- Functions ---
    void UpdateTipsLastTouchLocation(const Vector2D TipsLastTouchLocation);                    // [Final|Public] RVA: 0x5E52054
    void TimerForServerDebugRPC();                                                             // [Final|Public] RVA: 0x5E52040
    void TimerForHeartbeat();                                                                  // [Final|Public] RVA: 0x5E5202C
    void SetUIInputMode(enum UIMode);                                                          // [Final|Public] RVA: 0x5E51F94
    void SetSGCharacter(SGCharacter* InCharacter);                                             // [Final|Public] RVA: 0x5E51EF4
    void SetPlayerStartLocation(const Vector InPlayerStartLoc);                                // [Final|Public] RVA: 0x5E51E28
    void SetNewTraceInfoIndex(int32 InNewTraceInfoIndex);                                      // [Final|Public] RVA: 0x5E51D90
    void SetNetSpeedWhenLoadProtect(bool bRecoverDefaultValue);                                // [Final|Public] RVA: 0x4699A84
    void SetEscapePointIDs(const TArray<int32> InEscapePointIDs);                              // [Final|Public] RVA: 0x5E51C54
    void ServerUseVehicle(Actor* Vehicle, bool bWantDriver);                                   // [Public] RVA: 0x5E51758
    void ServerTLogSoundIndicatorScore(FString TLogInfo);                                      // [Public] RVA: 0x5E516AC
    void ServerTLogSoundIndicatorCount(int32 Count);                                           // [Public] RVA: 0x5E51610
    void ServerSwitchSeat(SGCharacter* NZChar, int32 NewSeatIndex);                            // [Public] RVA: 0x5E514F4
    void ServerSpectatingSettingsReport(const bool bAllowTeammatesCheckTheBackpack);           // [Public] RVA: 0x5E51454
    void ServerSetVehicleSpringArmRelativeRotation(Rotator InRelativeRot);                     // [Public] RVA: 0x5E51378
    void ServerSetVehicleCameraRelativeInfo(Rotator InRelativeRot, Vector InRelativeLoc);      // [Public] RVA: 0x5E51220
    void ServerSendTssAntiData(const TssAntiData AntiData);                                    // [Public] RVA: 0x5E510E0
    void ServerSendShootInputFlowData(const ShootInputFlowData InputData);                     // [Protected] RVA: 0x5E50FA8
    void ServerReplayButtonClickedReport(int32 SourceType);                                    // [Public] RVA: 0x5E50F0C
    void ServerNotifyPCSpawned();                                                              // [Public] RVA: 0x5E50EC0
    void ServerLeaveVehicle(Rotator CurrentRot);                                               // [Public] RVA: 0x5E50DE4
    void ServerHeartbeat(int32 PingNum);                                                       // [Public] RVA: 0x5E50D48
    void ServerForgiveTeammate(Character* TargetCharacter, bool bForgive, SGPlayerController* PC);  // [Public] RVA: 0x5E50C04
    void ServerDebugRPCTwo(FString Key, FString Value);                                        // [Public] RVA: 0x5E50AEC
    void ServerDebugRPC(FString Str);                                                          // [Public] RVA: 0x5E50A40
    void SendDebugRPC(int32 Len, int32 Last, int32 Num);                                       // [Final|Public] RVA: 0x5E50904
    void ProcessDebugCommand(FString Value);                                                   // [Public] RVA: 0x182D96C
    void OnRepDSSwitchConfig();                                                                // [Final|Protected] RVA: 0x17058B0
    void OnRep_PlayerStartLocation();                                                          // [Final|Private] RVA: 0x5E506C8
    void OnRep_NewTraceInfoIndex();                                                            // [Final|Protected] RVA: 0x5E5063C
    void OnRep_InTeamIndex();                                                                  // [Final|Private] RVA: 0x5E50628
    void OnRep_FinishType();                                                                   // [Final|Public] RVA: 0x5E505D4
    void OnRep_EscapePointIDs();                                                               // [Final|Private] RVA: 0x5E505C0
    void OnPlayerTryReconnect(NetConnection* InNetConnection);                                 // [Final|Protected] RVA: 0x5E50448
    void OnPlayerOnReconnect(PlayerController* InPC);                                          // [Final|Protected] RVA: 0x5E503AC
    void OnPlayerInputClassLoadCompleted(SoftObjectPath Path);                                 // [Final|Private] RVA: 0x5E502F4
    void OnPlayerFinishReconnect(NetConnection* InNetConnection);                              // [Final|Protected] RVA: 0x5E501AC
    void OnGameBegin(PlayerController* PlayerController);                                      // [Final|Public] RVA: 0x5E50110
    void OnCompetitionFlagChange(enum FlagType, bool bValue);                                  // [Final|Public] RVA: 0x5E4FF88
    void OnBUseSoundIndicatorChange(bool bUseSoundIndicator);                                  // [Final|Public] RVA: 0x5E4FE04
    uint8 MoveToLocation(const Vector Dest, float AcceptanceRadius, bool bStopOnOverlap, bool bUsePathfinding, bool bProjectDestinationToNavigation, bool bCanStrafe, TSubclassOf<NavigationQueryFilter> FilterClass, bool bAllowPartialPath);  // [Final|Public] RVA: 0x5E4FAE8
    void K2_SetInitialLocationAndRotation(const Vector NewLocation, const Rotator NewRotation);  // [Final|Public] RVA: 0x5E4F9B0
    void InitNewPlayer(const UniqueNetIdRepl UniqueID, const FString Options, const FString Portal);  // [Public] RVA: 0x5E4F7F8
    void GiveUpWFRToDie(Character* TargetCharacter);                                           // [Public] RVA: 0x5E4F740
    SGPCUIModeComponent* GetUIModeComponent();                                                 // [Final|Public] RVA: 0x5E4F71C
    SGPCSpectatingComponent* GetSpecatingComponent();                                          // [Final|Public] RVA: 0x5E4F658
    SGCharacter* GetSGCharacter();                                                             // [Final|Public] RVA: 0x5E4F634
    int32 GetNewTraceInfoIndex();                                                              // [Final|Public] RVA: 0x5E4F61C
    float GetMoveTimeDiff();                                                                   // [Final|Public] RVA: 0x5E4F5F4
    int32 GetLostPingSeconds();                                                                // [Final|Public] RVA: 0x5E4F5D4
    SGPCFPPModeComponent* GetFPPModeComponent();                                               // [Final|Public] RVA: 0x5E4F598
    SGCharacter* GetControlledSGCharacter();                                                   // [Final|Public] RVA: 0x5E4F580
    void ForgiveTeammate(Character* TargetCharacter, bool bForgive);                           // [Final|Public] RVA: 0x5E4F1F8
    void DSInitConfig();                                                                       // [Final|Protected] RVA: 0x5E4F1E4
    void CloseConnection();                                                                    // [Public] RVA: 0x5E4F1CC
    void ClientUseVehicleFailed();                                                             // [Public] RVA: 0x5E4F1B4
    void ClientUseTeleportCheckFrames(bool bEnable, bool bAutoStopHurryLoad);                  // [Public] RVA: 0x5E4F0B4
    void ClientReplayButtonClickedReport(int32 SourceType);                                    // [Public] RVA: 0x5E4F018
    void ClientHudAddToast(FString Tips);                                                      // [Public] RVA: 0x5E4EF18
    void ClientHeartbeat(int32 PingNum);                                                       // [Public] RVA: 0x5E4EE7C
    void ClientGetOutOfStuck(enum Result);                                                     // [Public] RVA: 0x5E4EDE0
    void ClientBroadcastHitTeammates(SGCharacter* DamageCauser);                               // [Public] RVA: 0x5E4ED40
    void CallServerGetOutOfStuckImpl(bool bClientStuck, const Vector StuckLocation);           // [Public] RVA: 0x5E4EB54
    void CallServerGetOutOfStuck();                                                            // [Final|Public] RVA: 0x5E4EB40
    void BeforeCloseConnection();                                                              // [Public] RVA: 0x182D96C
    void AfterPostInitializeComponents();                                                      // [Public] RVA: 0x182D96C
};
...
public:
    ...
    // --- Functions ---
    void UpdateServerOpenMicState(bool bOpen);                                                 // [Public] RVA: 0x5E5BA94
    void UpdatePing(float InPing);                                                             // [Public] RVA: 0x5E5B9F4
    void UpdateOpenMicState(bool bOpen);                                                       // [Final|Public] RVA: 0x5E5B938
    void SetZonePlayerName(FString NewName);                                                   // [Final|Public] RVA: 0x5E5B754
    void SetTicketValue(int32 InTicketValue);                                                  // [Final|Public] RVA: 0x5E5B68C
    void SetTeamTypeForTest(int32 InTeamType);                                                 // [Final|Public] RVA: 0x5E5B5E8
    void SetSquadID(int32 ID);                                                                 // [Final|Public] RVA: 0x5E5B530
    void SetSpecatedBanTime(float BanTime);                                                    // [Final|Public] RVA: 0x5E5B494
    void SetSignType(int32 Stype);                                                             // [Final|Public] RVA: 0x5E5B3D8
    void SetSGCharacter(SGCharacter* CurrentCharacter);                                        // [Final|Public] RVA: 0x5E5B300
    void SetCourtRanksInfo(int32 Level, int32 Elo);                                            // [Final|Public] RVA: 0x5E5B03C
    void ServerSetSignType(int32 Stype);                                                       // [Public] RVA: 0x5E5AF84
    void ServerReportRagdollOverridePose(SGCharacter* Character, uint8 reason, const Vector ClientPelvisLoc, float CostTime);  // [Public] RVA: 0x5E5ADFC
    void ServerMarkLastCameraAimTime();                                                        // [Public] RVA: 0x5E5ADB0
    void ServerClearLastCameraAimTime();                                                       // [Public] RVA: 0x5E5AD64
    void SendFinalFeedBack(SGCharacter* Character, bool bDecision);                            // [Public] RVA: 0x5E5A7C0
    void OnReq_RoomID();                                                                       // [Public] RVA: 0x2206644
    void OnRep_TeamIndex();                                                                    // [Public] RVA: 0x215B85C
    void OnRep_PlayerKDAInfo();                                                                // [Final|Public] RVA: 0x5E5A420
    void OnRep_PlayerIdentityType();                                                           // [Final|Public] RVA: 0x20517D4
    void OnRep_GID();                                                                          // [Final|Public] RVA: 0x1F88790
    void OnRep_ChatVoiceIDs();                                                                 // [Final|Public] RVA: 0x5E5A40C
    void OnRep_AllowTeammatesCheckTheBackpack();                                               // [Final|Public] RVA: 0x5E5A3F8
    void OnPostDied(Character* DeadCharacter, Controller* Killer, DamageEventObject* DamageEventObject);  // [Final|Public] RVA: 0x5E5A234
    void OnKillOther(const KillInfo KillInfo, const KillOtherStatis KillOtherStatics);         // [Final|Public] RVA: 0x5E59F3C
    void OnKilled(Pawn* KilledPawn, const KillInfo KillInfo);                                  // [Final|Public] RVA: 0x5E5A078
    void OnCharacterReadyToPlay(SGCharacter* Character);                                       // [Final|Protected] RVA: 0x5E59D70
    void LoadGuaranteeAdditionConf();                                                          // [Final|Public] RVA: 0x5E599EC
    bool IsReconnectSpawn();                                                                   // [Final|Public] RVA: 0x5E59900
    bool IsOBPlayer();                                                                         // [Final|Public] RVA: 0x5E598E0
    bool IsCancelReconnection();                                                               // [Final|Public] RVA: 0x5E59620
    bool IsAdministratorPlayer();                                                              // [Final|Public] RVA: 0x5E59604
    void IncreaseKillPlayerPMC();                                                              // [Final|Public] RVA: 0x5E59134
    void IncreaseKillAIPMC();                                                                  // [Final|Public] RVA: 0x5E590A8
    int32 GetSignType();                                                                       // [Final|Public] RVA: 0x5E58F38
    SGCharacter* GetSGCharacter();                                                             // [Final|Public] RVA: 0x5E58F14
    int32 GetRecentCollectionItemCounts(int32 InRecentTimes);                                  // [Final|Public] RVA: 0x5E58BD0
    enum GetPlayerTeamType();                                                                  // [Final|Public] RVA: 0x27B8AD8
    int32 GetPlayerNationalFlagIso();                                                          // [Final|Public] RVA: 0x29AE13C
    SGPlayerKDAInfo GetPlayerKDAInfo();                                                        // [Final|Public] RVA: 0x5E58AD8
    SGPlayerIconInfo GetPlayerIconInfo();                                                      // [Final|Public] RVA: 0x1F71D10
    SGPlayerBannerInfo GetPlayerBannerInfo();                                                  // [Final|Public] RVA: 0x1BA034C
    uint8 GetPlatformId();                                                                     // [Final|Public] RVA: 0x5E58924
    int32 GetKillNum();                                                                        // [Final|Public] RVA: 0x5E5885C
    int32 GetDeathNum();                                                                       // [Final|Public] RVA: 0x5E58824
    int32 GetCourtRankLevel();                                                                 // [Final|Public] RVA: 0x5E5880C
    int64 GetCharacterLootExtData(uint32 InType);                                              // [Final|Public] RVA: 0x5E586F0
    int32 GetAssistNum();                                                                      // [Final|Public] RVA: 0x5E586D8
    void ClientSendBanTimeForCauser();                                                         // [Public] RVA: 0x5E58614
    void CalculateLootGuaranteeFactor();                                                       // [Final|Public] RVA: 0x5E58600
    void AddCharacterLootExtData(uint32 InType, int64 InValue);                                // [Final|Public] RVA: 0x5E58420
};
...
public:
    ...
    // --- Functions ---
    void PoolEndPlay();                                                                        // [Final|Protected] RVA: 0x5E9AE28
    void PoolBeginPlay();                                                                      // [Final|Protected] RVA: 0x5E9AE10
};
...
public:
    ...
    // --- Functions ---
    void VisualizeBeamSegment(int32 Index, BeamSegmentData BeamSegmentData);                   // [Final|Protected] RVA: 0x5E78B50
    void SetTrajectoryFadeInCurrentTime(float SetTime);                                        // [Final|Public] RVA: 0x5E787B4
    void SetProceduralMeshLineOpacity(float Opacity);                                          // [Final|Public] RVA: 0x5E78720
    BeamSegmentData GetBeamSegmentDataAtTime(float BeginTime, float EndTime);                  // [Final|Protected] RVA: 0x5E783BC
    void CreateProceduralMesh_Complex(out TMap<Vector, Vector> TrajectoryPointsWithVelocity);  // [Final|Protected] RVA: 0x5E78168
    void CreateProceduralMesh(out TMap<Vector, Vector> TrajectoryPointsWithVelocity);          // [Final|Protected] RVA: 0x5E77FFC
    Vector CalcTargetLocation(const Vector InStartLocation, const Vector InInitialVelocity, float InTime);  // [Protected] RVA: 0x5E77D44
};
...
public:
    ...
    // --- Functions ---
    void PoolEndPlay();                                                                        // [Final|Public] RVA: 0x1D49AD4
    void PoolBeginPlay();                                                                      // [Final|Public] RVA: 0x1DCD9EC
};
...
public:
    ...
    // --- Functions ---
    bool RemoveFromTeam(Actor* C, bool bRemoveAll);                                            // [Public] RVA: 0x5E86208
    TArray<Actor*> GetTeamMembers();                                                           // [Public] RVA: 0x5E84B38
    ActorComponent* GetFactionComp();                                                          // [Public] RVA: 0x5E83930
    bool AddToTeam(Actor* C);                                                                  // [Public] RVA: 0x5E82648
};
...
public:
    ...
    // --- Functions ---
    void UpdateTeamStorageSearchingStateByPS(PlayerState* PlayerState);                        // [Public] RVA: 0x5E86FA8
    void SetTotalTeamStorageValue(int32 InTeamStorageTotalValue);                              // [Final|Public] RVA: 0x5E86EFC
    void SetTeamStorageValue(int32 InTeamStorageValue);                                        // [Final|Public] RVA: 0x5E86E64
    void SetTeamMemberDeathLocationArray(int32 PlayerIndex, Vector2D Pos);                     // [Final|Public] RVA: 0x5E86D80
    void SetTeamAreaIDArray(int32 PlayerIndex, int32 AreaID);                                  // [Final|Public] RVA: 0x5E86C98
    void SetStartPointGroupIndex(int32 InIndex);                                               // [Final|Public] RVA: 0x5E86BF4
    void SetOpenContainerLootProtectByTeammate(bool InOpenContainerLootProtectByTeammate);     // [Final|Public] RVA: 0x5E86B58
    void SetInBattleTeamMemberPlayerCondition(int32 PlayerIndex, enum Condition);              // [Final|Public] RVA: 0x5E86A70
    void SetAIGroupInfo(NPCAITeam* InAIGroupInfo);                                             // [Final|Public] RVA: 0x5E866AC
    void ServerSetTeamMemberDeathLocationArray(int32 PlayerIndex, Vector2D Pos);               // [Public] RVA: 0x5E86598
    void ServerClearTeamMemberInfo(int32 PlayerIndex);                                         // [Final|Public] RVA: 0x5E836BC
    void RemoveOBTeamMemberPlayer(Controller* C);                                              // [Final|Public] RVA: 0x5E86308
    void PlayerFinishGame(PlayerController* C, enum FinishType, Actor* EscapeVolume);          // [Public] RVA: 0x5E860D4
    void OnRoundGamePrepare();                                                                 // [Public] RVA: 0x1C6C308
    void OnRep_TotalTeamStorageValue();                                                        // [Final|Public] RVA: 0x206F460
    void OnRep_TeamStorageValue();                                                             // [Final|Public] RVA: 0x206F4C0
    void OnRep_TeamMemberStorageArr();                                                         // [Final|Public] RVA: 0x5E85D4C
    void OnRep_TeamMemberSignArray();                                                          // [Final|Public] RVA: 0x1F75558
    void OnRep_TeamMemberPlayerState();                                                        // [Final|Public] RVA: 0x244A2B0
    void OnRep_TeamMemberAICharacters();                                                       // [Final|Public] RVA: 0x1DF7F78
    void OnRep_TeamIndex();                                                                    // [Final|Public] RVA: 0x1F3C95C
    void OnRep_TeamConfirmedPerkID();                                                          // [Final|Public] RVA: 0x5E85D38
    void OnRep_TeamAreaID(const TArray<int32> OldValue);                                       // [Final|Public] RVA: 0x1A0B9EC
    void OnRep_InBattleTeamMemberPlayerStates();                                               // [Final|Public] RVA: 0x18516BC
    void OnRep_InBattleTeamMemberPlayerNames();                                                // [Final|Public] RVA: 0x1E44740
    void OnRep_InBattleTeamMemberPlayerCondition();                                            // [Final|Public] RVA: 0x20747CC
    void OnRep_InBattleTeamMemberNationalFlagIsos();                                           // [Final|Public] RVA: 0x218C9E4
    void OnRep_InBattleTeamMemberIconInfo();                                                   // [Final|Public] RVA: 0x1F72110
    void OnRep_InBattleTeamMemberBannerInfo();                                                 // [Final|Public] RVA: 0x1BA056C
    void OnRebornSaftyStateChanged(PlayerController* PlayerController, bool IsInRebornSafty);  // [Final|Public] RVA: 0x5C8406C
    void OnPlayerAddToTeam(Actor* C);                                                          // [Public] RVA: 0x5E85A98
    void OnInventoryParentActorChanged(SGInventory* InvActor, Actor* PreParentActor, Actor* ParentActor, int32 InParentIndex);  // [Final|Public] RVA: 0x5E85330
    void MulticastInBattleTeamMemberPlayerStates(const TArray<PlayerState*> PlayerStates);     // [Protected] RVA: 0x1C6CAA0
    bool IsGIDInTeam(int64 gid);                                                               // [Final|Public] RVA: 0x5E84FA0
    bool IsFriendlyToAll();                                                                    // [Public] RVA: 0x5E84F78
    void InitTeamStorageBox();                                                                 // [Public] RVA: 0x204CBE0
    void InitTeamStorage();                                                                    // [Public] RVA: 0x5C60FFC
    uint32 GetUnSettmentTeamMembersCount();                                                    // [Public] RVA: 0x5E84F50
    int32 GetTeamStorageValue(bool bIncludeRatio);                                             // [Public] RVA: 0x5E84E60
    int32 GetTeamStorageTotalValue();                                                          // [Final|Public] RVA: 0x5E84E48
    float GetTeamStorageRatio();                                                               // [Public] RVA: 0x5E84E1C
    int32 GetTeamStorageAvgNum();                                                              // [Public] RVA: 0x5E84DF4
    SGInventory* GetTeamStorage();                                                             // [Final|Public] RVA: 0x5E84DDC
    int32 GetTeamSignTypeMemberByIndex(int32 Index);                                           // [Final|Public] RVA: 0x5E84CEC
    int32 GetTeamPlayerNationalFlagIsoByIndex(int32 PlayerIndex);                              // [Final|Public] RVA: 0x5E84C14
    FString GetTeamPlayerNameByIndex(int32 PlayerIndex);                                       // [Final|Public] RVA: 0x1EC5F4C
    int64 GetTeamPlayerGIDByIndex(int32 PlayerIndex);                                          // [Final|Public] RVA: 0x5E84B6C
    int32 GetTeamMemberStorageValue(int64 gid);                                                // [Public] RVA: 0x5E84A88
    SGInventory* GetTeamMemberStorage(int64 gid);                                              // [Final|Public] RVA: 0x5E849E0
    Vector2D GetTeamMemberSignArrayVectorByIndex(int32 Index);                                 // [Public] RVA: 0x5E84938
    TArray<Vector2D> GetTeamMemberSignArray();                                                 // [Public] RVA: 0x5E84868
    uint32 GetTeamMembersCount();                                                              // [Final|Public] RVA: 0x29B0F14
    TArray<PlayerState*> GetTeamMemberPlayerStates();                                          // [Final|Public] RVA: 0x5E8484C
    TArray<ASGPlayerData> GetTeammemberPlayerInfoArray();                                      // [Public] RVA: 0x5E84F10
    int32 GetTeamMemberIndexByGID(int64 gid);                                                  // [Final|Public] RVA: 0x5E847A4
    int32 GetTeamMemberIndex(PlayerState* PS);                                                 // [Final|Public] RVA: 0x5E846FC
    int32 GetTeamMemberFinalTeamBoxReward(int64 gid);                                          // [Public] RVA: 0x5E8464C
    Vector2D GetTeamMemberDeathLocationByIndex(int32 Index);                                   // [Final|Public] RVA: 0x5E845A8
    TArray<Vector2D> GetTeamMemberDeathLocationArray();                                        // [Final|Public] RVA: 0x5E8458C
    enum GetTeamMemberConditionByIndex(int32 Index);                                           // [Final|Public] RVA: 0x1EEE720
    TArray<enum> GetTeamMemberCondition();                                                     // [Final|Public] RVA: 0x5E84468
    TArray<Character*> GetTeamMemberCharacters();                                              // [Public] RVA: 0x5E84438
    PlayerState* GetTeamMemberByIndex(int32 Index);                                            // [Final|Public] RVA: 0x1EE7E64
    SGAICharacter* GetTeamMemberAICharactersByGID(uint64 gid);                                 // [Final|Public] RVA: 0x5E84390
    TArray<SGAICharacter*> GetTeamMemberAICharacters();                                        // [Final|Public] RVA: 0x5E8433C
    int32 GetTeamIndex();                                                                      // [Final|Public] RVA: 0x5E84324
    int32 GetTeamIDMemberByIndex(int32 Index);                                                 // [Final|Public] RVA: 0x5E84250
    TArray<int64> GetTeamGuidIncludeNotConnect();                                              // [Final|Public] RVA: 0x5E84100
    TArray<int64> GetSuccessTeamMemberGIDArr();                                                // [Final|Public] RVA: 0x5E83FB0
    int32 GetStartPointGroupIndex();                                                           // [Final|Public] RVA: 0x5E83F98
    int32 GetPlayerVisualIdx(int64 Guid);                                                      // [Final|Public] RVA: 0x5E83EF0
    void GetPlayerOwnStorageInventorySourceInfo(PlayerState* PS, out TArray<InventorySourceInfo> InventorySourceInfos);  // [Public] RVA: 0x5E83DDC
    int32 GetPlayerInSquadIndex(PlayerState* PS);                                              // [Final|Public] RVA: 0x5E83D34
    void GetOwnStorageItems(PlayerState* PS, out TArray<SGPlayerItemInfoBase*> OutItemsInfo);  // [Public] RVA: 0x5E83C20
    TArray<Actor*> GetOBTeamMembers();                                                         // [Final|Public] RVA: 0x5E83C04
    uint32 GetNumHumans();                                                                     // [Final|Public] RVA: 0x5E83BE0
    uint32 GetNoDBNOTeamMembersCount(Controller* ExceptPlayer);                                // [Public] RVA: 0x5E83B30
    int32 GetInBattleTeamMembersIndex(PlayerState* PS);                                        // [Final|Public] RVA: 0x1A0B1C0
    TArray<PlayerState*> GetInBattleTeamMemberPlayerStates();                                  // [Final|Public] RVA: 0x5E83B14
    TArray<int32> GetInBattleTeamMemberPlayerNationalFlagIsos();                               // [Final|Public] RVA: 0x5E83AF8
    TArray<FString> GetInBattleTeamMemberNames();                                              // [Final|Public] RVA: 0x5E83ADC
    TArray<SGPlayerIconInfo> GetInBattleTeamMemberIconInfo();                                  // [Final|Public] RVA: 0x5E83AC0
    TArray<SGPlayerBannerInfo> GetInBattleTeamMemberBannerInfo();                              // [Final|Public] RVA: 0x5E83AA4
    int32 GetInBattlePlayerIndexByPS(PlayerState* CurPlayerState);                             // [Final|Public] RVA: 0x5E8395C
    int32 GetAreaIDByIndex(int32 Index);                                                       // [Final|Public] RVA: 0x5E83888
    TArray<TeamMemberStorageValue> GetAllTeamMemberStorageValues();                            // [Public] RVA: 0x5E83798
    TArray<int64> GetAllTeammateGID();                                                         // [Final|Public] RVA: 0xD4F39C
    uint32 GetAliveTeamMembersCount();                                                         // [Public] RVA: 0x5E83770
    NPCAITeam* GetAIGroupInfo();                                                               // [Final|Public] RVA: 0x5E83758
    void ClearTeamMemberInfo(int32 PlayerIndex);                                               // [Public] RVA: 0x5E836BC
    void AIFinishGame(Controller* C, enum FinishType, Actor* EscapeVolume);                    // [Public] RVA: 0x5E82210
    void AIEscaped(Character* AICharacter, Actor* EscapeVolume);                               // [Public] RVA: 0x5E82124
    void AddTGRSuccessLevelMember(int64 gid);                                                  // [Final|Public] RVA: 0x5E82494
    void AddTeamGuidIncludeNotConnect(int64 NewGuid);                                          // [Final|Public] RVA: 0x5E82560
    void AddOBTeamMemberPlayer(Controller* C);                                                 // [Final|Public] RVA: 0x5E82344
};
...
public:
    ...
    // --- Functions ---
    void SetNeedUpdateMeshInScope(bool InbNeedUpdate);                                         // [Final|Public] RVA: 0x5E97DE0
    void RefreshAllComponents();                                                               // [Public] RVA: 0x46F7084
    void OnRep_DestWeaponCharacter();                                                          // [Final|Public] RVA: 0x1BF5CB8
    void OnDetachedFromHand();                                                                 // [Final|Protected] RVA: 0x1C934D4
    void OnAttachedToHand();                                                                   // [Final|Protected] RVA: 0x1C9335C
    void MergeWeaponPIE();                                                                     // [Final|Public] RVA: 0x1E39618
    bool IsLeverAction();                                                                      // [Final|Public] RVA: 0x5E979F0
    SGWeaponZoomComponent* GetWeaponZoomComp();                                                // [Final|Public] RVA: 0x5E9744C
    enum GetWeaponType();                                                                      // [Final|Public] RVA: 0x5E97434
    SGWeaponTacticalInvStateComponent* GetWeaponTacticalInvStateComp();                        // [Final|Public] RVA: 0x5E97410
    SGWeaponSpreadComponent* GetWeaponSpreadComp();                                            // [Final|Public] RVA: 0x5E973EC
    SGWeaponRecoilComponent* GetWeaponRecoilComp();                                            // [Final|Public] RVA: 0x5E973C8
    SGWeaponMovementComponent* GetWeaponMovementComp();                                        // [Final|Public] RVA: 0x5E973A4
    SGWeaponMeshComponent* GetWeaponMeshComp();                                                // [Final|Public] RVA: 0x5E97380
    SGWeaponMergeComponent* GetWeaponMergeComp();                                              // [Final|Public] RVA: 0x5E9735C
    SGWeaponImpactComponent* GetWeaponImpactComp();                                            // [Final|Public] RVA: 0x5E97338
    SGWeaponHeatComponent_HD* GetWeaponHeatComp();                                             // [Final|Public] RVA: 0x5E97314
    SGWeaponFiringComponent* GetWeaponFiringComp();                                            // [Final|Public] RVA: 0x5E972F0
    SGWeaponFireIntervalComponent* GetWeaponFireIntervalComp();                                // [Final|Public] RVA: 0x5E972CC
    SGWeaponDurabilityComponent* GetWeaponDurabilityComp();                                    // [Final|Public] RVA: 0x5E972A8
    enum GetWeaponDetectorType();                                                              // [Final|Public] RVA: 0x5E97290
    bool GetWeaponCanTacticalPistol();                                                         // [Final|Public] RVA: 0x5E97274
    SGWeaponCameraComponent* GetWeaponCameraComp();                                            // [Final|Public] RVA: 0x5E97250
    SGWeaponBoreComponent* GetWeaponBoreComp();                                                // [Final|Public] RVA: 0x5E9722C
    int64 GetWeaponAssembleID();                                                               // [Final|Public] RVA: 0x5E97214
    SGWeaponAssembleComponent* GetWeaponAssembleComp();                                        // [Final|Public] RVA: 0x5E971F0
    SGWeaponAppearanceComponent* GetWeaponAppearanceComp();                                    // [Final|Public] RVA: 0x5E971CC
    SGUAMWeaponAnimationComponent* GetWeaponAnimationComp();                                   // [Final|Public] RVA: 0x5E971A8
    SGWeaponAmmoComponent* GetWeaponAmmoComp();                                                // [Final|Public] RVA: 0x5E97184
    bool GetNeedUpdateMeshInScope();                                                           // [Final|Public] RVA: 0x5E96AE0
    SGUAMWeaponModifyBoneComponent* GetModifyBoneComp();                                       // [Final|Public] RVA: 0x5E96ABC
    enum GetMeleeWeaponSubType();                                                              // [Final|Public] RVA: 0x5E969E8
    enum GetMeleeWeaponAnimType();                                                             // [Final|Public] RVA: 0x5E969D0
    bool GetIsUseWalkHandIkAdditiveInSprint();                                                 // [Final|Public] RVA: 0x5E96858
    bool GetIgnoreWeaponLODPolicy();                                                           // [Final|Public] RVA: 0x5E9683C
    enum GetGunWeaponSubType();                                                                // [Final|Public] RVA: 0x5E96824
    SGGunSoundComponent* GetGunSoundComp();                                                    // [Final|Public] RVA: 0x5E96800
};
...
public:
    ...
    // --- Functions ---
    void SetUseCache(bool bUse);                                                               // [Final|Public] RVA: 0x5E9F84C
    void SetupLightingBeforeCapture(SGInventory* InInventory);                                 // [Public] RVA: 0x1EB3310
    void SetTextureParameterValue(MaterialInstanceDynamic* AssembleRTMaterial, Texture* Texture);  // [Final|Protected] RVA: 0x5E9F768
    void SetOverrideLightGroupType(enum InOverrideLightGroupType);                             // [Final|Protected] RVA: 0x5E9F6D4
    void SetCameraPos(SceneCaptureComponent2D* SceneCaptureComp, Vector Pos, Vector Offset);   // [Final|Protected] RVA: 0x5E9F370
    void ResetRT(Box Box, SceneCaptureComponent2D* SceneCaptureComp, float ImgWidth, bool UseViewportSize, bool UseDefine);  // [Final|Protected] RVA: 0x5E9E770
    void ReleaseRT(Image* Image);                                                              // [Final|Public] RVA: 0x5E9E0F4
    bool RefreshWeaponWithImage(SGInventory* InInventory, Object* Image, bool bSaveRT, Rotator TargetRot, float CameraPosX);  // [Final|Public] RVA: 0x5E9DEF8
    void InitalizeAssembleSystem(SGInventory* InInventory);                                    // [Final|Public] RVA: 0x5E9D790
    void ClearLoadedInv();                                                                     // [Final|Public] RVA: 0x5E9C3BC
    void CaptureWeaponToRT();                                                                  // [Final|Protected] RVA: 0x5E9C380
    bool CaptureAlways(bool bAlways);                                                          // [Final|Public] RVA: 0x5E9C0D4
    void CancelRenderImg(Image* TargetImg);                                                    // [Final|Public] RVA: 0x5E9C038
    void AllocateRT(FString UniqueID);                                                         // [Final|Public] RVA: 0x5E9BF84
    void AdjustCameraNearClippingPlane();                                                      // [Final|Protected] RVA: 0x5E9BC7C
    void AddLoadedInv(SGInventory* Inv, int32 ItemId);                                         // [Final|Public] RVA: 0x5E9B9E4
};
...
public:
    ...
    // --- Functions ---
    void StartAutoCapture();                                                                   // [Final|Public] RVA: 0x5EA2E50
    void ReleaseRT(Image* Image);                                                              // [Final|Public] RVA: 0x14E0834
    bool RefreshWeaponWithImage(SGInventory* InInventory, Object* Image, bool bSaveRT, Rotator TargetRot, float CameraPosX);  // [Final|Public] RVA: 0x5EA25D8
    void OnWeaponLoadComplete(FString UniqueID, SGAssembleBase* AssembleEnv);                  // [Final|Public] RVA: 0x1E46500
    bool IsManagedEnv(SGWeaponAssembleEnvironment* env);                                       // [Final|Public] RVA: 0x5EA224C
    void CancelRenderImg(Image* TargetImg);                                                    // [Final|Public] RVA: 0x5EA17C8
    void AllocateRT(FString UniqueID);                                                         // [Final|Public] RVA: 0x5EA15F4
};
...
public:
    ...
    // --- Functions ---
    void OnRep_AimingRotationOffset();                                                         // [Final|Protected] RVA: 0xEE545C
    void DisablePartCollision(FName BoneName);                                                 // [Final|Public] RVA: 0x6809238
};
...
public:
    ...
    // --- Functions ---
    bool SetItemWithImage(SGInventory* InInventory, Object* Image);                            // [Final|Public] RVA: 0x680A730
    void SetDefineSize(Vector2D DefineSize);                                                   // [Final|Public] RVA: 0x680A578
    void ResetCacheShowInfo();                                                                 // [Final|Public] RVA: 0x680A21C
    void OnScroll(float Rate);                                                                 // [Final|Public] RVA: 0x680A180
    void OnInputTouchPC(uint8 Handle, uint8 Type, const Vector Location);                      // [Final|Public] RVA: 0x6809ED4
    void ClearCache();                                                                         // [Final|Public] RVA: 0x68091E8
    bool CheckOnLoading();                                                                     // [Final|Public] RVA: 0x680903C
    void CaptureExtra(TMap<FString, Object*> ImageMap);                                        // [Final|Public] RVA: 0x6808E14
};
...
public:
    ...
    // --- Functions ---
    void OnGameFlowStateChanged(FName NewState, FName OldState);                               // [Final|Public] RVA: 0x22CB438
};
...
public:
    ...
    // --- Functions ---
    void SetTutorialHintWidgets(const TArray<FString> InWidgetPaths);                          // [Final|Public] RVA: 0x6829454
    void SetTutorialHintItemIDs(const TArray<int32> InItemIDs);                                // [Final|Public] RVA: 0x68292FC
    void SetTutorialHintBagWidgetIDs(bool bIsCorpse, const TArray<enum> InWidgetIDs);          // [Final|Public] RVA: 0x68291E0
    void SaveTraceQuest();                                                                     // [Final|Public] RVA: 0x68291CC
    void ResetTraceTask(int32 TaskId);                                                         // [Final|Public] RVA: 0x6829134
    void RemoveTraceTask(int32 TaskId);                                                        // [Final|Public] RVA: 0x682909C
    void RemoveCompleteTraceTask();                                                            // [Final|Public] RVA: 0x6829088
    void RefreshQuestBeforeState(int32 InQuestID, PlayerController* InPC);                     // [Final|Public] RVA: 0x6828FA4
    void PrintReplicateData();                                                                 // [Final|Public] RVA: 0x6828F90
    void OnQuestGraphStatusChange(MFQuestNodeGraph* NodeGraph, enum NewStatus);                // [Final|Protected] RVA: 0x6828A04
    void LoadTraceQuest();                                                                     // [Final|Public] RVA: 0x6827E0C
    bool IsSeasonQuest(int32 InGraphID);                                                       // [Final|Public] RVA: 0x6827D78
    TArray<FString> GetTutorialHintWidgets();                                                  // [Final|Public] RVA: 0x6827D38
    TArray<int32> GetTutorialHintItemIDs();                                                    // [Final|Public] RVA: 0x6827D1C
    TArray<enum> GetTutorialHintBagWidgetIDs(bool bIsCorpse);                                  // [Final|Public] RVA: 0x6827C64
    TArray<int32> GetTraceTasks();                                                             // [Final|Public] RVA: 0x6827B5C
    int32 GetQuestIDFromQuest(MFQuestBase* InQuest);                                           // [Final|Public] RVA: 0x6827A80
    int32 GetQuestGraphIDFromQuestGraph(MFQuestNodeGraph* InGraph);                            // [Public] RVA: 0x68279D0
    MFQuestNodeGraph* GetQuestGraphByID(int32 InGraphID, PlayerController* InPlayerController);  // [Final|Public] RVA: 0x68278D8
    QuestReplicateData GetQuestDataWithID(int32 InGraphID, PlayerController* InPC);            // [Final|Public] RVA: 0x6827740
    void GetPlayerSeasonQuestsPartByState(PlayerController* InPC, out TArray<QuestReplicateData> InProgress, out TArray<QuestReplicateData> Success, out TArray<QuestReplicateData> Fail);  // [Final|Public] RVA: 0x6827538
    TArray<TraceableActorInfo> GetPlayerQuestTraceInfos(PlayerController* InPC);               // [Final|Public] RVA: 0x68271B0
    TraceableActorInfo GetPlayerQuestTraceInfoByTargetID(PlayerController* InPC, int32 TargetId);  // [Final|Public] RVA: 0x6827078
    void GetPlayerQuestsPartByState(PlayerController* InPC, out TArray<QuestReplicateData> InProgress, out TArray<QuestReplicateData> Success, out TArray<QuestReplicateData> Fail);  // [Final|Public] RVA: 0x6827330
    TArray<QuestReplicateData> GetPlayerQuests(PlayerController* InPC);                        // [Final|Public] RVA: 0x6827270
    int32 GetMaxTraceNum();                                                                    // [Final|Public] RVA: 0x6827060
    MFQuestBase* GetGraphQuestFromQuestID(MFQuestNodeGraph* InGraph, int32 InQuestID);         // [Final|Public] RVA: 0x6826F28
    int32 GetGraphIDFromQuest(MFQuestBase* InQuest);                                           // [Final|Public] RVA: 0x6826E90
    TArray<QuestInventory> GetAllQuestInventoryData(PlayerController* PC);                     // [Final|Public] RVA: 0x6826DD0
    MFQuestNodeGraph* CreateNewQuestGraphWithID(int32 InGraphID, Controller* InController, bool bAct);  // [Public] RVA: 0x6826C64
    MFQuestBase* CreateNewQuestFromID(int32 InGraphID, int32 InQuestID, Controller* InController);  // [Final|Public] RVA: 0x6826B24
    MFQuestBase* CreateNewQuestFromCreateData(out TaskCreateData InTaskCreateData, out QuestCreateData InQuestCreateData);  // [Final|Public] RVA: 0x68268E0
    void ClearTutorialHint();                                                                  // [Final|Public] RVA: 0x68268CC
    void ClearTraceTask();                                                                     // [Final|Public] RVA: 0x6826868
    void AutoTraceOneQuest();                                                                  // [Final|Public] RVA: 0x6826218
    void AddTraceTask(int32 TaskId);                                                           // [Final|Public] RVA: 0x6826180
};
...
public:
    ...
    // --- Functions ---
    void UpdateFactionmemberLocationInfo();                                                    // [Final|Public] RVA: 0x68681A4
    void SetFactionmamberCharacterByGID(uint64 gid, SGCharacter* SGCharacter);                 // [Final|Public] RVA: 0x6867B9C
    void OnPlayerFinishGame(PlayerController* C, enum FinishType, Actor* EscapeVolume);        // [Final|Public] RVA: 0x68675AC
    void OnCharacterKilled(Pawn* KilledPawn, const KillInfo KillInfo);                         // [Final|Public] RVA: 0x6867358
    void OnAIEscaped(Character* AICharacter, Actor* EscapeVolume);                             // [Final|Public] RVA: 0x6867270
    TArray<FactionmemberBaseInfo> GetTeammemberPlayerBaseInfoArray();                          // [Final|Public] RVA: 0x6866F00
    void AddNewFactionmemberBaseInfo(FString PlayerName, uint64 gid, uint64 TeamIndex, enum CharacterType, SGCharacter* Character);  // [Final|Public] RVA: 0x68663C4
};
...
public:
    ...
    // --- Functions ---
    void SetTeamMemberPlayerInfoArray(int32 PlayerIndex, TeamPlayerInfo PlayerInfo);           // [Final|Public] RVA: 0x68D79B8
    void ReleaseTeamMemberStorage(int64 gid);                                                  // [Final|Public] RVA: 0x68D722C
    void RefreshTeamInfo();                                                                    // [Final|Public] RVA: 0x68D7218
    void PlayerStateRepFinish(SGPlayerState* SGPS);                                            // [Final|Public] RVA: 0x68D717C
    void OnTeamStorageChanged();                                                               // [Final|Public] RVA: 0x68D7168
    void OnTeamMemberStorageChanged();                                                         // [Final|Public] RVA: 0x68D7154
    void OnRoundControlStateChanged(PlayerController* PlayerController, enum RoundState, int32 CurrRound);  // [Final|Public] RVA: 0x68D7014
    void OnRep_TeamMemberPlayerInfosArray();                                                   // [Final|Public] RVA: 0x1D7B604
    void OnRep_TeammemberPlayerBaseInfoArray();                                                // [Final|Public] RVA: 0x1C88ADC
    void OnInventoryBeginPlay(SGInventory* Inventory, enum InventoryType);                     // [Final|Public] RVA: 0x68D6B08
    void OnEscapePointsChange(PlayerState* PlayerState, const TArray<int32> EscapePointIDs);   // [Final|Public] RVA: 0x68D695C
    int32 GetTeamMemberValidPlayerSignNum();                                                   // [Final|Public] RVA: 0x68D6714
    TeammemberTitleInfo GetTeamMemberTitleInfo(int32 InTeamIndex);                             // [Final|Public] RVA: 0x68D663C
    int32 GetTeamMembersIndexByPlayerInfo(Actor* C);                                           // [Final|Public] RVA: 0x68D6738
    Vector2D GetTeamMemberSignPositionByIndexAndSignType(int32 Index, enum Type);              // [Final|Public] RVA: 0x68D6548
    TeamPlayerInfo GetTeamMemberPlayerInfoByIndex(int32 Index);                                // [Final|Public] RVA: 0x68D6350
    TeamPlayerBaseInfo GetTeamMemberPlayerBaseInfoByIndex(int32 Index);                        // [Final|Public] RVA: 0x68D6268
    TArray<TeammemberPlayerBaseInfo> GetTeammemberPlayerBaseInfoArray();                       // [Final|Public] RVA: 0x68D67E0
    int32 GetTargetMemberIdxByTaskId(int32 TaskId, int32 selfTeamId);                          // [Final|Public] RVA: 0x68D6170
    int32 GetTargetMemberIdxByConfigID(int32 ConfigID, int32 selfTeamId);                      // [Final|Public] RVA: 0x68D6078
    int32 GetSquadIndex(int32 Index);                                                          // [Final|Public] RVA: 0x68D5FA4
    void GetRefTeamMemberSignPositionByIndexAndSignType(int32 Index, enum Type, out Vector2D Pos);  // [Final|Public] RVA: 0x68D5D80
    bool GetRefTeamMemberPlayerInfoByIndex(int32 Index, out TeamPlayerInfo Info);              // [Final|Public] RVA: 0x68D5C68
    int32 GetPlayerSortIndex(int32 IndexInTeam);                                               // [Final|Public] RVA: 0x68D5AAC
    int32 GetChangeTeamPlayerInfo(TArray<TeamPlayerInfo> OldInfosArray, TArray<TeamPlayerInfo> NewInfosArray, out enum SignType, out bool IsNewSign);  // [Final|Public] RVA: 0x68D552C
    void ClearRefreshTeamInfoTimerHandle();                                                    // [Final|Public] RVA: 0x68D5350
};
